...
class Gstr2DetailExport implements FromView, WithEvents
{
    ...
    public function view(): View
    {
        ...
        return view('company.pages.gst.gstr2.detail_export', [
    ...
    private function getSectionConfig(): array
    {
        ...
        switch ($this->section) {
            case 'b2b':
                return [
                    'title' => 'GSTR-2 — B2B Invoices (3, 4A)',
                    'headings' => ['#', 'Supplier Name', 'GSTIN', 'Invoice / Note No', 'Date', 'Place of Supply', 'RC', 'Taxable Amount', 'CGST %', 'CGST Amount', 'SGST %', 'SGST Amount', 'IGST %', 'IGST Amount', 'CESS Amount', 'Total Tax Amount', 'Invoice Value'],
            ...
            case 'b2bur':
                return [
                    'title' => 'GSTR-2 — B2BUR Invoices (4B)',
                    'headings' => ['#', 'Supplier Name', 'Invoice / Note No', 'Date', 'Place of Supply', 'Taxable Amount', 'CGST %', 'CGST Amount', 'SGST %', 'SGST Amount', 'IGST %', 'IGST Amount', 'CESS Amount', 'Total Tax Amount', 'Invoice Value'],
            ...
            case 'cdnr':
                return [
                    'title' => 'GSTR-2 — Credit/Debit Notes (Registered) (6C)',
                    'headings' => ['#', 'Supplier Name', 'GSTIN', 'Invoice / Note No', 'Date', 'Place of Supply', 'RC', 'Taxable Amount', 'CGST %', 'CGST Amount', 'SGST %', 'SGST Amount', 'IGST %', 'IGST Amount', 'CESS Amount', 'Total Tax Amount', 'Invoice Value'],
                    'alignments' => ['C', 'L', 'L', 'L', 'C', 'L', 'C', 'R', 'C', 'R', 'C', 'R', 'C', 'R', 'R', 'R', 'R'],
                    'totalLabelCol' => 6,
                    'totals' => ['taxable_amount' => 0, 'cgst_amount' => 0, 'sgst_amount' => 0, 'igst_amount' => 0, 'cess_amount' => 0, 'total_tax_amount' => 0, 'invoice_value' => 0],
            ...
            case 'cdnu':
                return [
                    'title' => 'GSTR-2 — Credit/Debit Notes (Unregistered)',
                    'headings' => ['#', 'Supplier Name', 'Invoice / Note No', 'Date', 'Place of Supply', 'Taxable Amount', 'CGST %', 'CGST Amount', 'SGST %', 'SGST Amount', 'IGST %', 'IGST Amount', 'CESS Amount', 'Total Tax Amount', 'Invoice Value'],
                    'alignments' => ['C', 'L', 'L', 'C', 'L', 'R', 'C', 'R', 'C', 'R', 'C', 'R', 'R', 'R', 'R'],
                    'totalLabelCol' => 5,
                    'totals' => ['taxable_amount' => 0, 'cgst_amount' => 0, 'sgst_amount' => 0, 'igst_amount' => 0, 'cess_amount' => 0, 'total_tax_amount' => 0, 'invoice_value' => 0],
            ...
            case 'import_goods':
                return [
                    'title' => 'GSTR-2 — Import of Goods / Capital Goods',
                    'headings' => ['#', 'Supplier Name', 'Invoice / Note No', 'Date', 'Taxable Amount', 'IGST %', 'IGST Amount', 'CESS Amount', 'Total Tax Amount', 'Invoice Value'],
            ...
            case 'import_services':
                return [
                    'title' => 'GSTR-2 — Import of Services (4C)',
                    'headings' => ['#', 'Supplier Name', 'Invoice / Note No', 'Date', 'Taxable Amount', 'IGST %', 'IGST Amount', 'CESS Amount', 'Total Tax Amount', 'Invoice Value'],
                    'alignments' => ['C', 'L', 'L', 'C', 'R', 'C', 'R', 'R', 'R', 'R'],
                    'totalLabelCol' => 4,
                    'totals' => ['taxable_amount' => 0, 'igst_amount' => 0, 'cess_amount' => 0, 'total_tax_amount' => 0, 'invoice_value' => 0],
            ...
            case 'nil_rated':
                return [
                    'title' => 'GSTR-2 — Nil Rated Invoices (7A, 7B)',
                    'headings' => ['#', 'Supplier Name', 'Invoice / Note No', 'Date', 'Place of Supply', 'Taxable Amount', 'Invoice Value'],
            ...
            case 'hsn_detail':
                $hsnTitle = 'GSTR-2 — HSN Details' . ($this->hsnCode ? " (HSN: {$this->hsnCode})" : '');
                return [
                    'title' => $hsnTitle,
                    'headings' => ['#', 'HSN Code', 'Item Name', 'UQC', 'Qty', 'Supplier Name', 'Invoice / Note No', 'Date', 'Taxable Amount', 'CGST %', 'CGST Amount', 'SGST %', 'SGST Amount', 'IGST %', 'IGST Amount', 'CESS Amount', 'Total Tax Amount', 'Invoice Value'],
            ...
            default:
                return [
                    'title' => 'GSTR-2 — HSN-wise Summary of Inward Supplies',
