...
class GodownExport implements FromView, WithEvents
{
    protected $company;
    protected $godowns;
    protected $headings;
    ...
    public function __construct($company, $godowns, $headings)
    {
    ...
    {
        $rows = $this->godowns->map(function ($godowns) {
            return [
                $godowns->destinationName->name,
                $godowns->godown_name,
                $godowns->remark,
            ];
        });
