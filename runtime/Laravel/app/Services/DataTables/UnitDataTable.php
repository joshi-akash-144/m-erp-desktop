...
class UnitDataTable
{
    ...
    public function getData($query): JsonResponse
    {
        ...
        if ($request->has('filter_unit_id') && $request->input('filter_unit_id') !== '') {
            $query->where('id', $request->input('filter_unit_id'));
        }
        ...
        // Add row numbers manually for consistent numbering across pages
