...
use App\Models\CreditNoteVoucher;
...
class CreditNoteVoucherService
{
    ...
    public function createVoucher(array $data, $companyId, $financialYearId)
    {
        ...
        return DB::transaction(function () use ($data, $companyId, $financialYearId) {
            ...
            $journal = CreditNoteVoucher::create([
            ...
            $voucher->update([
                'source_type' => SourceType::CREDIT_NOTE,
    ...
    public function prepareVoucherPayload(array $data, $companyId, $financialYearId)
    {
        ...
        return [
            ...
            'journal' => $this->prepareCreditNote($data, $serialInfo, $companyId, $financialYearId)
        ];
    }


    private function prepareCreditNote($data, $serialInfo, $companyId, $financialYearId)
    {
        return [
            'company_id'        => $companyId,
            'financial_year_id' => $financialYearId,
    ...
    private function prepareVoucherData(array $data, $serialInfo, $companyId, $financialYearId)
    {
        return [
            ...
            'voucher_type_id'  => VoucherType::CREDIT_NOTE,
            'reference_id'     => null,
            'reference_type'   => Reference::CreditNote,
    ...
    {
        $voucherTypeId = VoucherType::CREDIT_NOTE;
        $offset = ($page - 1) * $size;
        ...
        $permissions = userPermissions([
            'credit_note_voucher.view',
            'credit_note_voucher.update',
            'credit_note_voucher.delete',
            'credit_note_voucher.print-voucher',
        ], true);
    ...
    public function details($id)
    {
        ...
        $journal = CreditNoteVoucher::withTrashed()->where('voucher_id', $id)->first();
    ...
    public function voucherSerials(int $companyId, int $financialYearId){
        ...
        return  Voucher::where('company_id', $companyId)
            ...
            ->where('voucher_type_id', VoucherType::CREDIT_NOTE)
            // ->where('journal_entry_from', CreditNoteVoucher::ENTRY_FORM_VOUCHER)
    ...
    public function updateVoucher($voucherId, array $data, $companyId, $financialYearId)
    {
        ...
        return DB::transaction(function () use ($voucherId, $data, $companyId, $financialYearId) {
            ...
            $journal = CreditNoteVoucher::where('voucher_id', $voucherId)->firstOrFail();
    ...
    public function deleteVoucher(int $voucherId): void
    {
        ...
        DB::transaction(function () use ($voucherId) {
            ...
            $journalVoucher = CreditNoteVoucher::where('voucher_id', $voucherId)->first();
    ...
    private function logAudit($data, $voucher, $action)
    {
        ...
        $auditData = [
            ...
            'action'            => $action,
            'module'            => SourceType::CREDIT_NOTE,
            'record_type'       => AuditTrail::RECORD_TYPE_VOUCHER,
            'model_name'        => CreditNoteVoucher::class,
