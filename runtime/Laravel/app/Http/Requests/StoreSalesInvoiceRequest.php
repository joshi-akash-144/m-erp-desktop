...
class StoreSalesInvoiceRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('sales_invoice.create');
    }
    ...
    public function rules(): array
    {
        ...
        return [
            'uuid'                      => ['required', 'uuid', Rule::unique('sales_invoices', 'uuid')
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            //     $validator->errors()->add('delivery_date', 'Delivery date must be within financial year.');
            // }
        });
    }
}
