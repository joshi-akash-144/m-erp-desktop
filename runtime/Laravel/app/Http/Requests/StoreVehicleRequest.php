...
class StoreVehicleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'national_permit_due_date' => ['nullable', 'date', 'date_format:Y-m-d'],
            'fitness_due_date' => ['nullable', 'date', 'date_format:Y-m-d'],
            // 'agent_name' => ['nullable', 'string', 'max:255'],
            'policy_due_date' => ['nullable', 'date', 'date_format:Y-m-d'],
            'passing_due_date' => ['nullable', 'date', 'date_format:Y-m-d'],
            'tax_due_date' => ['nullable', 'date', 'date_format:Y-m-d'],
            'permit_due_date' => ['nullable', 'date', 'date_format:Y-m-d'],
            'puc_no' => ['nullable', 'string', 'max:255'],
            'puc_due_date' => ['nullable', 'date', 'date_format:Y-m-d'],
