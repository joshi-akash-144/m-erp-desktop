...
use App\Exports\CreditNoteVoucherRegisterExport;
...
class CreditNoteVoucherController extends Controller
{
    protected CreditNoteVoucherService $service;
    protected MasterDataService $masterDataService;
    protected CompanyService $companyService;

    public function __construct(MasterDataService $masterDataService, CreditNoteVoucherService $service, CompanyService $companyService)
    {
        // Apply middleware for permissions
        $this->middleware('permission:credit_note_voucher.list')->only(['index']);
        $this->middleware('permission:credit_note_voucher.create')->only(['create', 'store']);
        $this->middleware('permission:credit_note_voucher.update')->only(['edit', 'update']);
        $this->middleware('permission:credit_note_voucher.delete')->only('destroy');
        $this->middleware('permission:credit_note_voucher.restore')->only('restore');
    ...
    public function index(Request $request)
    {
        ...
        return view('company.pages.credit-note-voucher.index', compact('accounts', 'vouchers'));
    }
    ...
    public function create()
    {
        ...
        return view('company.pages.credit-note-voucher.create', compact('serial', 'ledgerAccounts'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return AjaxResponse::success(
                message: "Credit Note Voucher Number {$voucher->voucher_serial} has been created successfully.",
                data: $voucher
            );
            ...
            return AjaxResponse::error(
                message: __('messages.credit_note_voucher.throwable_error'),
                code: 500,
                errors: $e->getMessage()
            );
        }
    ...
    public function edit(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return AjaxResponse::success(
                message: "Credit Note Voucher details has been fetched successfully.",
                data: $data
            );
        }
        $companyId = company_id();
        ...
        $ledgerAccounts = $this->masterDataService->get('accounts', company_id());        return view('company.pages.credit-note-voucher.edit', compact('voucherSerials', 'ledgerAccounts', 'voucherId'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        try {
            ...
            return AjaxResponse::success(
                message: "Credit Note Voucher {$voucher->voucher_serial} has been updated successfully.",
                data: $voucher
            );
        } catch (ValidationException $e) {
            return response()->json([
    ...
    public function destroy(string $id)
    {
        ...
        try {
            ...
            return AjaxResponse::success(message: 'Credit Note Voucher deleted successfully.');
        } catch (Throwable $e) {
            report($e);
    ...
    public function print(Request $request): JsonResponse
    {
        ...
        $html = view('company.pages.credit-note-voucher.print', [
            'company'     => $company,
        ...
        return AjaxResponse::success('Credit Note Voucher Register printed successfully.', ['html' => $html]);
    }
    ...
    public function exportExcel(Request $request): JsonResponse
    {
        try {
            ...
            $fileName = "{$slug}_credit_note_voucher_register_" . now()->format('d_m_Y_His') . '.xlsx';

            Excel::store(
                new CreditNoteVoucherRegisterExport($company, $formattedData, $headings, $datePeriod),
                "{$directory}/{$fileName}",
                'public',
                \Maatwebsite\Excel\Excel::XLSX
            );

            return AjaxResponse::success('Credit Note Voucher Register exported successfully (xlsx)', [
...
public function printVoucher(string $id)
    {
        ...
        return view('company.pages.credit-note-voucher.print-journal', compact(
            'company',
            'voucher_serial',
            'voucher_date',
            'receipt_voucher_data',
