...
class ReceiptVoucherController extends Controller
{
    ...
    public function __construct(MasterDataService $masterDataService, ReceiptVoucherService $service, CompanyService $companyService)
    {
        $this->middleware('permission:receipt_voucher.list')->only(['index']);
        $this->middleware('permission:receipt_voucher.create')->only(['create', 'store']);
        $this->middleware('permission:receipt_voucher.update')->only(['edit', 'update']);
        $this->middleware('permission:receipt_voucher.delete')->only('destroy');
        $this->middleware('permission:receipt_voucher.print-voucher')->only('print-voucher');
    ...
    public function index(Request $request)
    {
        ...
        return view('company.pages.receipt-voucher.index', compact('accounts', 'vouchers'));
    }
    ...
    public function create()
    {
        ...
        return view('company.pages.receipt-voucher.create', compact('serial', 'ledgerAccounts'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return AjaxResponse::success(
                message: "Receipt Voucher Number {$voucher->voucher_serial} has been created successfully.",
                data: $voucher
            );
    ...
    public function edit(Request $request)
    {
        if ($request->ajax()) {
            ...
            return AjaxResponse::success(
                message: "Receipt Voucher details has been fetched successfully.",
                data: $data
            );
        }
        ...
        return view('company.pages.receipt-voucher.edit', compact('voucherSerials', 'ledgerAccounts', 'voucherId'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        try {
            ...
            return AjaxResponse::success(
                message: "Receipt Voucher {$voucher->voucher_serial} has been updated successfully.",
                data: $voucher
            );
        } catch (ValidationException $e) {
            return response()->json([
    ...
    public function destroy(string $id)
    {
        ...
        try {
            ...
            return AjaxResponse::success(message: 'Receipt Voucher deleted successfully.');
        } catch (Throwable $e) {
            report($e);

            return AjaxResponse::error(
                message: 'Failed to delete receipt voucher.',
                code: 500,
                errors: $e->getMessage()
            );
        }
    ...
    public function details(string $id)
    {
        try {
            ...
            return AjaxResponse::error(
                message: 'Failed to fetch receipt voucher details.',
                code: 500,
                errors: $e->getMessage()
            );
        }
    ...
    public function printVoucher(string $id)
    {
        ...
        return view('company.pages.receipt-voucher.print-receipt', compact(
            'company',
            'voucher_serial',
            'voucher_date',
            'receipt_voucher_data',
    ...
    public function print(Request $request): JsonResponse
    {
        ...
        $html = view('company.pages.receipt-voucher.print', [
            'company'     => $company,
        ...
        return AjaxResponse::success('Receipt Voucher Register printed successfully.', ['html' => $html]);
    }
    ...
    public function exportExcel(Request $request): JsonResponse
    {
        try {
            ...
            $fileName = "{$slug}_receipt_voucher_register_" . now()->format('d_m_Y_His') . '.xlsx';
