...
use App\Exports\JournalVoucherRegisterExport;
...
class JournalVoucherController extends Controller
{
    ...
    public function __construct(MasterDataService $masterDataService, JournalVoucherService $service, CompanyService $companyService)
    {
        // Apply middleware for permissions
        $this->middleware('permission:journal_voucher.list')->only(['index']);
        $this->middleware('permission:journal_voucher.create')->only(['create', 'store']);
        $this->middleware('permission:journal_voucher.update')->only(['edit', 'update']);
        $this->middleware('permission:journal_voucher.delete')->only('destroy');
        $this->middleware('permission:journal_voucher.restore')->only('restore');
    ...
    public function index(Request $request)
    {
        ...
        return view('company.pages.journal-voucher.index', compact('accounts', 'vouchers'));
    }
    ...
    public function create()
    {
        ...
        $vehicles = Vehicle::where('company_id', company_id())->get(['id', 'name']);
        $tdsCategories = \App\Models\TdsCategory::where('company_id', company_id())->get(['id', 'category_name']);

        return view('company.pages.journal-voucher.create', compact('serial', 'ledgerAccounts','vehicles', 'tdsCategories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return AjaxResponse::success(
                message: "Journal Voucher Number {$voucher->voucher_serial} has been created successfully.",
                data: $voucher
            );
            ...
            return AjaxResponse::error(
                message: __('messages.journal_voucher.throwable_error'),
                code: 500,
                errors: $e->getMessage()
            );
        }
    ...
    public function edit(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return AjaxResponse::success(
                message: "Journal Voucher details has been fetched successfully.",
                data: $data
            );
        }
        $companyId = company_id();
        ...
        $ledgerAccounts = $this->masterDataService->get('accounts', company_id());
        $vehicles = Vehicle::where('company_id', $companyId)->get(['id', 'name']);
        
        $tdsCategories = \App\Models\TdsCategory::where('company_id', $companyId)->get(['id', 'category_name']);

        return view('company.pages.journal-voucher.edit', compact('voucherSerials', 'ledgerAccounts', 'voucherId', 'vehicles', 'tdsCategories'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        try {
            ...
            return AjaxResponse::success(
                message: "Journal Voucher {$voucher->voucher_serial} has been updated successfully.",
                data: $voucher
            );
        } catch (ValidationException $e) {
            return response()->json([
    ...
    public function destroy(string $id)
    {
        ...
        try {
            ...
            return AjaxResponse::success(message: 'Journal Voucher deleted successfully.');
        } catch (Throwable $e) {
            report($e);
    ...
    public function print(Request $request): JsonResponse
    {
        ...
        $html = view('company.pages.journal-voucher.print', [
            'company'     => $company,
        ...
        return AjaxResponse::success('Journal Voucher Register printed successfully.', ['html' => $html]);
    }
    ...
    public function exportExcel(Request $request): JsonResponse
    {
        try {
            ...
            $fileName = "{$slug}_journal_voucher_register_" . now()->format('d_m_Y_His') . '.xlsx';

            Excel::store(
                new JournalVoucherRegisterExport($company, $formattedData, $headings, $datePeriod),
                "{$directory}/{$fileName}",
                'public',
                \Maatwebsite\Excel\Excel::XLSX
            );

            return AjaxResponse::success('Journal Voucher Register exported successfully (xlsx)', [
...
public function printVoucher(string $id)
    {
        ...
        return view('company.pages.journal-voucher.print-journal', compact(
            'company',
            'voucher_serial',
            'voucher_date',
            'receipt_voucher_data',
