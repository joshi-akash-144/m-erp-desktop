...
class PaymentVoucherRegisterController extends Controller
{
    ...
    {    
        ...
        return view('company.pages.payment-voucher-register.index', compact('customers'));        
    }
    ...
    {       
        ...
        $formattedData = $voucher->references->map(function($alloc) use ($voucher) {
    ...
    public function print(Request $request): JsonResponse
    {
        ...
        $html = view('company.pages.payment-voucher-register.print', $data)->render();

        return AjaxResponse::success(
            message: 'Payment Voucher Register printed successfully.',
            data: [
                'html' => $html,
            ]
        );
    ...
    public function exportExcel(Request $request): JsonResponse
    {
        try {
            ...
            $fileName = "{$companyNameSlug}_payment_voucher_register_" . now()->format('d_m_Y_His') . ".xlsx";
