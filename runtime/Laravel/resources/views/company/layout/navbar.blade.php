...
<header class="navbar navbar-expand-md d-print-none">
    <div class="container-xl">
        ...
        <div class="navbar-nav flex-row order-md-last">
            <!-- <div class="nav-item d-flex me-3 align-items-center">
                {{-- Electron Update Button --}}
                <a href="#" id="check-updates-btn" class="btn btn-outline-primary btn-1 waves-effect" data-bs-toggle="modal" data-bs-target="#updateModal" title="Check for Updates">
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    // Show check updates button if electronAPI exists
    const checkUpdateBtn = document.getElementById('check-updates-btn');
    if (checkUpdateBtn) {
        checkUpdateBtn.classList.remove('d-none');
    }
    ...
    function setUpdateState(state, text = '') {
        ...
        if (state === 'checking') {
            ...
            updateLaterBtn.disabled = true; // prevent closing while checking
