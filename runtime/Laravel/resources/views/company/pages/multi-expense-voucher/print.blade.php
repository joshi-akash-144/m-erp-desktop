...
<head>
    ...
    <title>Multi Expense Voucher – {{ $expense->voucher?->voucher_serial ?? $expense->id }}</title>
    <style>
        *,
        *::before,
        *::after {
...
<body>
    ...
    <header>
        ...
        <h2 class="report-title">Multi Expense Voucher @if($chunks->count() > 1) <span style="font-size:12px;font-weight:normal;">(Page {{ $chunkIndex + 1 }})</span> @endif</h2>
        ...
        <div class="report-meta">
            <span><strong>Party (Cr) :</strong> {{ $expense->account?->name ?? '-' }}</span>
        ...
        <table class="report-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">{{ $item->bill_date ? \Carbon\Carbon::parse($item->bill_date)->format('d/m/Y') : '' }}</td>
