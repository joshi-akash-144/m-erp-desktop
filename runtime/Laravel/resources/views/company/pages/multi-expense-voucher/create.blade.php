                                ...
                                <table class="table border border-1 border-dark-subtle table-bordered mb-0"
                                    ...
                                    <tbody id="multi_expense_table_body">
                                        ...
                                        <tr data-index="{{ $i }}">
                                            ...
                                            <td><input type="text" class="form-control row-challan-no" placeholder=""></td>
...
@section('script')
<script>
    const storeMultiExpenseVoucherUrl = "{{ route('multi-expense.store') }}";
    const pendingChallansUrl = "{{ route('multi-expense.pending-challans') }}";
</script>
<script src="{{ asset('js/modules/multi-expense/create.js') }}?v={{ time() }}"></script>
@endsection
