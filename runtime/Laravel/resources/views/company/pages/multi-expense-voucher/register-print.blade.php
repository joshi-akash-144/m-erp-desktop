...
<head>
    <meta charset="UTF-8">
    <title>Multi Expense Voucher Register</title>
    <style>
        *,
        *::before,
        *::after {
...
<body>
    ...
    <header>
        ...
        <h2 class="report-title">Multi Expense Voucher Register</h2>
    ...
    <main>
        ...
        <div class="continuation-header">
            ...
            <p class="page-info">Page {{ $page }} of {{ $totalPages }} &mdash; Multi Expense Voucher Register</p>
        </div>
        ...
        <table class="report-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="bold-cell">{{ $row['account_name'] ?? '-' }}</td>
