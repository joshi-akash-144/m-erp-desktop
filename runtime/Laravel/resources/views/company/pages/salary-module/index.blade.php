...
@section('title', 'Salary Voucher Register')
...
<style>
    ...
    /* Parent voucher row */
    #salary_module_register_table .tabulator-row.row-parent {
        background-color: #1e3a5f !important;
        color: #fff !important;
        font-weight: 600;
    }

    #salary_module_register_table .tabulator-row.row-parent:hover {
        background-color: #24467a !important;
    }

    #salary_module_register_table .tabulator-row.row-parent .tabulator-cell {
        color: #fff !important;
        border-right-color: #2d4f70 !important;
    }

    /* Total row */
    #salary_module_register_table .tabulator-row.row-total {
        background-color: #e3eaf2 !important;
        font-weight: 700;
    }

    #salary_module_register_table .tabulator-row.row-total .tabulator-cell {
        border-right-color: #9aa5b1 !important;
    }

    /* Item row */
    #salary_module_register_table .tabulator-row.row-item {
        background-color: #fff;
    }

    #salary_module_register_table .tabulator-row.row-item:hover {
            ...
            <div class="card border-0 shadow-sm rounded-0" style="background: linear-gradient(145deg, #ffffff, #f8f9fa);">
                <div class="card-body p-1 d-flex flex-wrap align-items-center justify-content-between gap-3 border-start border-4 border-primary rounded-0">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        @can('salary_module_voucher.create')
                        <a href="{{ route('salary-module.create') }}"
    ...
    <div class="page-body">
        ...
        <div class="card">
            <div class="card-body p-0">
                <div id="salary_module_register_table"></div>
            </div>
        </div>
        ...
        <div class="modal-content border-0 shadow">
            <div class="modal-header bg-primary text-white py-2">
                <h5 class="modal-title fw-bold">
                    <i class="fa-regular fa-file-lines me-2"></i> Salary Details
                </h5>
                    ...
                    <div class="card border-0 shadow-sm mb-3">
                        <div class="card-body p-3">
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    <span class="text-muted small d-block mb-1">Month</span>
                                    <strong id="view_month">-</strong>
                                </div>
                                <div class="col-md-3">
...
@section('script')
<script>
    const salaryModuleListUrl = "{{ route('salary-module.list') }}";
    const salaryModulePrintUrl = "{{ route('salary-module.print', ':id') }}";
    const salaryModuleEditUrl = "{{ route('salary-module.edit', ':id') }}";
    const salaryModuleDataUrl = "{{ route('salary-module.data', ':id') }}";
    const salaryModuleRegisterPrintUrl = "{{ route('salary-module.register-print') }}";
</script>
<script src="{{ asset('js/utils/icons.js') }}?v={{ hash_file('md5', public_path('js/utils/icons.js')) }}"></script>
<script src="{{ asset('js/modules/salary-module/index.js') }}?v={{ hash_file('md5', public_path('js/modules/salary-module/index.js')) }}"></script>
@endsection