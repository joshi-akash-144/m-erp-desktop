            ...
            <div class="card border-0 shadow-sm rounded-0">
                <div class="card-body p-1 d-flex flex-wrap align-items-center justify-content-between gap-3 border-start border-4 border-danger rounded-0">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <span class="badge bg-warning text-dark fw-bold text-uppercase px-3 py-1" style="font-size:0.75rem;">
                            <i class="fa-solid fa-pen me-1"></i> Edit
                        </span>
                    </div>
                    <div class="d-flex align-items-center gap-2">
                        @can('credit_note.create')
                            <a href="{{ route('credit-notes.create') }}" class="btn btn-sm btn-outline-success">
    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="card p-3 shadow-sm">
                @include('company.pages.credit-note._form', ['formMode' => 'edit'])
            </div>
        </div>
    </div>
...
@include('company.partials._shortcuts-bar', [
    'barModuleLabel'     => 'Credit Note Edit',
    'barModuleShortcuts' => [
...
@section('script')
<script>
    const cnUpdateUrl        = "{{ url('vouchers/credit-notes') }}";
    ...
    const editCreditNoteId   = {{ $creditNoteId ?? 'null' }};
</script>
