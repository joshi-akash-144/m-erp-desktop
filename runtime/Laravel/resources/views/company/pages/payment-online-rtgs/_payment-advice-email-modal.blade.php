        ...
        <div class="modal-content" style="border-radius:6px; overflow:hidden;">
            ...
            <div class="modal-header py-2 px-3" style="background:#1a3c5e;">
                <h5 class="modal-title mb-0 text-white fw-bold" id="paEmailModalLabel">
                    <i class="fa-solid fa-file-invoice me-2"></i> Payment Advice — Email Compose
                </h5>
                        ...
                        <tr>
                            ...
                            <td style="padding:8px 10px;">
                                <span class="text-muted" style="font-size:13px;">
                                    ...
                                    Payment advice PDF will be auto-generated and attached.
                                </span>
                            </td>
                        </tr>
            ...
            <div class="modal-footer py-2 px-3 justify-content-end gap-2">
                ...
                <button type="button" id="pa_email_send_btn" class="btn btn-sm btn-primary">
