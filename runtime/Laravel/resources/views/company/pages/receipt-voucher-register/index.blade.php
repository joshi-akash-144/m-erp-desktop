                        ...
                        <div class="card-body p-2">
                            <div class="mb-3">
                                <h4 class="font-monospace d-inline border-bottom border-2 border-primary pb-1">
                                    Receipt Voucher Reference Preview
                                </h4>
                            </div>
                                    ...
                                    <tbody id="ref_preview_table_body" class="border border-dark-subtle">
                                        <tr>
                                            <td colspan="5" class="text-center text-muted fw-semibold py-3">
                                                Click on any row to view <span class="text-primary">Receipt Voucher Reference</span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
...
@endsection
<script>
    const receiptVoucherRegisterListUrl = "{{ route('receipt-vouchers.index') }}";
    const getReceiptVoucherReference = "{{ route('receipt-vouchers.references') }}";
   
</script>

@section('script')
    <script src="{{ asset('js/modules/receipt-voucher-register/index.js') }}?v={{ hash_file('md5', public_path('js/modules/receipt-voucher-register/index.js')) }}"></script>
@endsection