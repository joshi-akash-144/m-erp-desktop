    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content shadow border-0">
            ...
            <div class="modal-footer">
                ...
                {{-- @can('journal_voucher.print-voucher')
                <a href="javascript:void(0)" type="button" class="btn btn-primary waves-effect" id="btn_print_journal">
                    <i class="fa-solid fa-print me-1"></i> Print Journal
                </a>
                @endcan --}}
