    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="card p-2 shadow-sm">
                @include('company.pages.payment-voucher._form', ['formMode' => 'create'])
            </div>
        </div>
    </div>
</div>
...
@include('company.partials._shortcuts-bar', [
    'barModuleLabel'     => 'Payment Voucher Create',
    'barModuleShortcuts' => [
...
@section('script')
<script src="{{ asset('js/modules/payment-voucher/create.js') }}?v={{ hash_file('md5', public_path('js/modules/payment-voucher/create.js')) }}"></script>
@endsection
