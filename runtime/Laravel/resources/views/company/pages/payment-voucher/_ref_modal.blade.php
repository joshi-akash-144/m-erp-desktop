    ...
    <div class="modal-dialog modal-xl" style="max-width: 45% !important;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header module-form-section rounded-0">
                <h5 class="modal-title">Bill-by-bill Adjustment of Amount</h5>
            ...
            <div class="modal-body">
                ...
                {{-- Attached Purchase Order display --}}
                <div id="ref_po_display" class="mb-2 d-none"></div>
                        ...
                        <table class="table table-bordered" style="table-layout: fixed; width:100%;" id="ref_table">
                            ...
                            <tbody id="ref_table_body" class="ref-table-body" data-pending-refs="[]">
                                <tr class="ref-row">
                                    ...
                                    <td><input type="text" class="form-control ref-number" value="ONAC"></td>
            ...
            <div class="modal-footer d-flex justify-content-between">
                ...
                <button type="button" class="btn btn-outline-success non-selectable" id="btn_attach_po">
                    <i class="fa-solid fa-paperclip me-2"></i>
                    Attach PO</button>
                <button type="button" class="btn btn-danger non-selectable" id="all_ref_clear" title="Clear all saved references">
