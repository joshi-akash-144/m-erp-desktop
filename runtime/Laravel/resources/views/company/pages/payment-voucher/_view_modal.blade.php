    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content shadow border-0">
            ...
            <div class="modal-body">
                <div class="module-form-section">
                    ...
                    <div class="card border mb-1">
                        <div class="card-body p-2">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <span id="purchase_order_serial_wrap" class="fs-4 fw-bold text-primary text-end" style="display:none;">
                    ...
                    <div class="module-page-footer mt-0" id="view_secondary_narration_row" style="display:none;">
                        <span class="fw-bold">Cheque:</span> <span id="view_secondary_narration" class="bg-white text-dark p-1">--</span>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                @can('payment_voucher.print-voucher')
                <a href="javascript:void(0)" type="button" class="btn btn-primary waves-effect" id="btn_print_payment">
                    <i class="fa-solid fa-print me-1"></i> Advice Print
                </a>
                @endcan
