<form id="receipt_voucher_form" autocomplete="off" data-form-mode="{{ $formMode }}" action="{{ route('receipt-vouchers.store') }}">
    ...
    <div class="row">
        <div class="col-lg-9" style="max-height: 400px; overflow-y: auto; position: relative;">
            <table class="table border border-1 border-dark-subtle table-bordered" id="receipt_voucher_table"
                ...
                <tbody id="receipt_voucher_table_body">
                    @for ($i = 0; $i < 50; $i++)
