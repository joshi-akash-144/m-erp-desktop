...
@section('title', 'Receipt Voucher Create')
@section('css')
            ...
            <div class="card border-0 shadow-sm rounded-0" style="background: linear-gradient(145deg, #ffffff, #f8f9fa);">
                <div class="card-body p-1 d-flex flex-wrap align-items-center justify-content-between gap-3 border-start border-4 border-primary rounded-0">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        @can('receipt_voucher.update')
                            <a href="{{ route('receipt-vouchers.edit') }}"
    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="card p-2 shadow-sm">
                @include('company.pages.receipt-voucher._form', ['formMode' => 'create'])
            </div>
        </div>
    </div>
</div>
...
@include('company.partials._shortcuts-bar', [
    'barModuleLabel'     => 'Receipt Voucher Create',
    'barModuleShortcuts' => [
