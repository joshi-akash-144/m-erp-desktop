...
<div class="modal fade" id="payment_voucher_modal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
                    ...
                    <div class="card border mb-1">
                        <div class="card-body p-2">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <span id="purchase_order_serial_wrap" class="fs-4 fw-bold text-primary text-end" style="{{ !empty($purchase_order_serials) ? '' : 'display:none;' }}">
                                    Purchase Order: <span id="purchase_order_serial" class="text-dark">{{ $purchase_order_serials ?? '--' }}</span>
                                </span>
                            </div>
                                            ...
                                            @if(isset($detail->refs) && count($detail->refs) > 0)
                                                @foreach($detail->refs as $ref)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-end font-monospace">{{ function_exists('formatQty') ? formatQty($pQtyVal ?? 0, 3) : number_format($pQtyVal ?? 0, 3) }}</td>
