...
@section('title', 'Sales Order Detail with Bill – List')
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                @php
                                    $actions = exportActions('sales-order-with-bill', 'sales_order');
                                @endphp
                            ...
                            <div class="card">
                                ...
                                <div class="p-3">
                                    <div id='filters' class="row g-2 m-erp-so-row-1">
                                        ...
                                        <label for="account_id" class="fs-4 fw-bold" value="">Customer Name</label>
                                ...
                                <!-- 🔹 Sales Order Bill Details Table -->
                                <div class="card-body p-0">
                                    <div id="sales_order_detail_table">
...
@section('script')
    <script>
            const salesOrderDetailListUrl = "{{ route('sales-orders.sales_order_with_bill') }}";
    </script>
    <script src="{{ asset('js/modules/sales-order/sales-order-detail-with-bill.js') }}?v={{ hash_file('md5', public_path('js/modules/sales-order/sales-order-detail-with-bill.js')) }}"></script>
@endsection
