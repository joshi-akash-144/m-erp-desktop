                ...
                <div class="card-body p-1 d-flex flex-wrap align-items-center justify-content-between gap-3 border-start border-4 border-sales rounded-0">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        @can('sales_order.update')
                            <a href="{{ route('sales-orders.edit') }}" class="btn btn-sm btn-outline-primary"
        ...
        <div class="page-body">
            <div class="container-xl">
                <div class="card p-2 shadow-sm">
                    @include('company.pages.sales-order._form', ['formMode' => 'create'])
                </div>
            </div>
        </div>
    </div>
@include('company.partials._shortcuts-bar', [
    'barModuleLabel'     => 'Sales Order Create',
    'barModuleShortcuts' => [
