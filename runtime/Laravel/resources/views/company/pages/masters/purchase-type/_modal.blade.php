...
$title = $modalData['title'] ?? 'Add Purchase Type';
$uuid = $modalData['uuid'] ?? '';
...
<div class="modal fade master-modal" id="purchase_type_modal" data-bs-backdrop="static" 
     data-bs-keyboard="false" tabindex="-1" aria-labelledby="purchase_type_modal" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="purchase_type_form"
              action="{{ $formMode === 'edit' ? route('purchase-types.update', $data->id) : route('purchase-types.store') }}"
              method="POST"
        ...
        <div class="col-md-12">
          ...
          <div class="master-form-section">
            <div class="master-section-title "><i class="fa-solid fa-bag-shopping me-2 text-primary"></i>Purchase Type Details</div>
              <div class="row g-2">
                  <!-- Purchase Type Name -->
                  <div class="col-lg-4 col-sm-3 col-md-12">
                      ...
                      <input type="text" name="name" id="name" class="form-control"
                          placeholder="{{ $isView ? '' : 'Enter purchase type name' }}"
      ...
      <div class="col-md-12">
          ...
          <div class="master-form-section">
            ...
            <div class="row g-2">  
                <!-- Taxation Type -->
                  @php
$taxationType = config('constants.purchase_taxation_types');
                  @endphp
                <div class="col-lg-4" id="primary_group_div">
                ...
                <!-- Region -->
                  @php
$regions = config('constants.purchase_regions');
                  @endphp
                <div class="col-lg-4">
                ...
                <div class="col-lg-4 col-sm-12 col-md-12">
                  @php $transaction = config('constants.purchase_transaction_types'); @endphp
          ...
          <div class="master-form-section {{ $gstSectionClass }}" id="gst_detail_section">
            ...
            <div class="row g-2">  
                ...
                <div class="col-lg-4 {{$cgstSectionClass}}" id="cgst_section">
                    ...
                    <input type="number" name="cgst" id="cgst" class="form-control" placeholder="{{ $isView ? '' : 'Enter purchase type cgst' }}"
                ...
                <div class="col-lg-4 {{$sgstSectionClass}}" id="sgst_section">
                    ...
                    <input type="number" name="sgst" id="sgst" class="form-control" placeholder="{{ $isView ? '' : 'Enter purchase type sgst' }}"
                ...
                <div class="col-lg-4 {{$igstSectionClass}}" id="igst_section">
                    ...
                    <input type="number" name="igst" id="igst" class="form-control" placeholder="{{ $isView ? '' : 'Enter purchase type igst' }}"
...
<div class="modal-footer">
       <button type="button" class="btn btn-link non-selectable waves-effect" data-bs-dismiss="modal">Close</button>
        @if(!$isView)
        <button type="submit" form="purchase_type_form" class="btn btn-primary form-save-btn waves-effect">
...
<script src="{{ asset('js/master/purchase-type/modal.js') }}?v={{ hash_file('md5', public_path('js/master/purchase-type/modal.js')) }}"></script>  
