...
<head>
    <meta charset="utf-8">
    <title>Purchase Type Report - Print</title>
    ...
    <main class="print-main">
        <div class="report-content page-{{ $orientation }}">
            <table class="w-100 report-table">
                ...
                <tbody>
                    @forelse($purchaseTypes as $index => $purchaseType)
                    @php
                    $rowCountOnPage++;
                    ...
                    <tr>
                        ...
                        <td class="text-start ps-2" style="width: {{ $tableConfig['columns'][1]['width'] }};">
                            {{ Str::limit($purchaseType->name, 40) }}
                        </td>
                        
                        {{-- Specific Account --}}
                        <td class="text-start ps-2" style="width: {{ $tableConfig['columns'][2]['width'] }};">
                            {{ Str::limit($purchaseType->account->name, 40) }}
                        </td>

                        {{-- Taxation Type --}}
                        <td class="text-start ps-2" style="width: {{ $tableConfig['columns'][3]['width'] }};">
                            {{ Str::limit($purchaseType->taxation_type, 40) }}
                        </td>

                        {{-- Transaction Type --}}
                        <td class="text-start ps-2" style="width: {{ $tableConfig['columns'][3]['width'] }};">
                            {{ Str::limit($purchaseType->transaction_type, 40) }}
                        </td>

                        {{-- Region --}}
                        <td class="text-start ps-2" style="width: {{ $tableConfig['columns'][3]['width'] }};">
                            {{ Str::limit($purchaseType->region, 40) }}
                        </td>
                    </tr>
