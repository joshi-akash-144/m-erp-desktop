...
<head>
    <meta charset="utf-8">
    <title>Account Report - Print</title>
        ...
        <div class="report-content page-{{ $orientation }}">
            <table class="w-100 report-table">
                ...
                <tbody>
                    ...
                    $ob = $obMap->get($account->id);
                    $obDr = ($ob && $ob->debit > 0) ? number_format($ob->debit, 2) : '0.00';
                    $obCr = ($ob && $ob->credit > 0) ? number_format($ob->credit, 2) : '0.00';
                    @endphp
                    ...
                    <tr>
                        ...
                        <td class="text-start ps-2" style="width: {{ $tableConfig['columns'][1]['width'] }};">
                            {{ Str::limit($account->name, 48) }}
                        </td>

                        {{-- Account Group --}}
                        <td class="text-start ps-2" style="width: {{ $tableConfig['columns'][2]['width'] }};">
                            {{ Str::limit($account->accountGroup->name, 29) ?? 'Primary Group'}}
                        </td>

                        {{-- Opening Balance Dr --}}
                        <td class="text-end ps-2" style="width: {{ $tableConfig['columns'][3]['width'] }};">
                            {{ $obDr }}
                        </td>
