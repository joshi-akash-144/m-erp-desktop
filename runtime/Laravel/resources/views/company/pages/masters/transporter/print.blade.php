...
<head>
    <meta charset="utf-8">
    <title>Transporter Report - Print</title>
            ...
            <table class="w-100 report-table">
                ...
                <tbody>
                    @forelse($accountGroups as $index => $group)
                        ...
                        <tr>
                            {{-- No. --}}
                            <td class="text-center" style="width: {{ $tableConfig['columns'][0]['width'] ?? 'auto'}};">
                                {{ $index + 1 }}.
                            </td>

                            {{-- Name --}}
                            <td class="text-start ps-2" style="width: {{ $tableConfig['columns'][1]['width'] ?? 'auto'}};">
                                {{ Str::limit($group->name, 40) }}
                            </td>

                            {{-- GSTIN No. --}}
                            <td class="text-start ps-2" style="width: {{ $tableConfig['columns'][2]['width'] ?? 'auto' }};">
                                {{ $group->gst_number ?? '-' }}
                            </td>

                            {{-- PAN No. --}}
                            <td class="text-start ps-2" style="width: {{ $tableConfig['columns'][3]['width'] ?? 'auto' }};">
                                {{ $group->pan_number ?? '-' }}
                            </td>

                            {{-- Mobile No. --}}
                            <td class="text-end ps-2" style="width: {{ $tableConfig['columns'][4]['width'] ?? 'auto' }};">
                                {{ $group->mobile_no ?? '-' }}
                            </td>

                            {{-- City --}}
                            <td class="text-end ps-2" style="width: {{ $tableConfig['columns'][5]['width'] ?? 'auto' }};">
                                {{ $group->city->name ?? '-' }}
                            </td>
