        ...
        <div class="container-xl">
            <div class="card border-0 shadow-sm rounded-0" style="background: linear-gradient(145deg, #ffffff, #f8f9fa);">
                <div class="card-body p-1 d-flex flex-wrap align-items-center justify-content-between gap-3 border-start border-4 border-primary rounded-0">
                    ...
                    @canany(['transporter.print', 'transporter.export'])
                        <div class="dropdown">
                            <button
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                @php
                                    $actions = exportActions('transporters', 'transporter');
                                @endphp
                    ...
                    @endcanany
                        ...
                        @can('transporter.create')
                            <a href="#"
                                ...
                                data-module="masters/transporter/modal"
                                data-init="openTransporterCreateModal">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <div class="card border-0 border-start border-4 border-primary">
                                <div class="card-body shadow p-2">
                                    <h3 class="page-title font-monospace"><i class="fa-solid fa-truck text-primary"></i>&nbsp;Transporter List</h3>  
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="filterCollapse">
                            <div class="card-body border-bottom">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4 col-lg-3">
                                        <label class="form-label fw-bold">Select Transporter</label>
...
@section('script')
    <script>
        const transporterListUrl = "{{ route('transporters.index') }}";
        const createRouteUrl = "{{ route('transporters.create') }}";
        const editRouteUrl = "{{ route('transporters.edit', ':id') }}";
        const viewRouteUrl = "{{ route('transporters.show', ':id') }}";
        const deleteRouteUrl = "{{ route('transporters.destroy', ':id') }}";
    </script>
    <script src="{{ asset('js/utils/icons.js') }}?v={{ hash_file('md5', public_path('js/utils/icons.js')) }}"></script>
    
    <script src="{{ asset('js/master/transporter/index.js') }}?v={{ hash_file('md5', public_path('js/master/transporter/index.js')) }}"></script>  
@endsection
