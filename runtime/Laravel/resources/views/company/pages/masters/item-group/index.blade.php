                ...
                <div class="card-body p-1 d-flex flex-wrap align-items-center justify-content-between gap-3 border-start border-4 border-primary rounded-0">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <div class="bg-primary-lt text-primary rounded-circle d-flex align-items-center justify-content-center shadow-sm" style="width: 38px; height: 38px;">
                            <i class="fs-3 fa-solid fa-boxes-packing"></i>
                        </div>
                        <div>
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        @can('item_group.create')
                            ...
                            data-module="masters/item-group/modal"
                            data-init="openItemGroupCreateModal">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <div class="card border-0 border-start border-4 border-primary">
                                <div class="card-body shadow p-2">
                                    <h3 class="page-title font-monospace"><i class="fa-solid fa-boxes-packing text-primary"></i>&nbsp;Item Groups List</h3>  
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card border-0 border-end border-4 border-primary">
                                <div class="card-body shadow-sm p-2">
                                    <div class="d-flex flex-wrap justify-content-md-end justify-content-start gap-2">
                                        ...
                                        {{-- @canany(['item_group.print', 'item_group.export'])
                                            <div class="dropdown">
                                                <button
...
@section('script')
    <script>
        const itemGroupListUrl = "{{ route('item-groups.index') }}";
        const createRouteUrl = "{{ route('item-groups.create') }}";
        const editRouteUrl = "{{ route('item-groups.edit', ':id') }}";
        const viewRouteUrl = "{{ route('item-groups.show', ':id') }}";
        const deleteRouteUrl = "{{ route('item-groups.destroy', ':id') }}";
    </script>
    <script src="{{ asset('js/utils/icons.js') }}?v={{ hash_file('md5', public_path('js/utils/icons.js')) }}"></script>
    
    <script src="{{ asset('js/master/item-group/index.js') }}?v={{ hash_file('md5', public_path('js/master/item-group/index.js')) }}"></script>  
@endsection