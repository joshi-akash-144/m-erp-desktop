                ...
                <div class="card-body p-1 d-flex flex-wrap align-items-center justify-content-between gap-3 border-start border-4 border-primary rounded-0">
                      ...
                      {{-- Export Dropdown (only for users with print/export permission) --}}
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                @php
                                    $actions = exportActions('units', 'unit');
                                @endphp
                    ...
                    @can('unit.create')
                        <a href="#" class="btn btn-outline-primary btn-sm js-load-modal"
                            data-module="masters/unit/modal" data-init="openUnitCreateModal">
                        ...
                        <div class="row g-2 align-items-center justify-content-between">
                            ...
                            <div class="card border-0 border-start border-4 border-primary">
                                <div class="card-body shadow p-2">
                                    <h3 class="page-title font-monospace"><i class="fa-solid fa-scale-balanced text-primary"></i>&nbsp;Unit List</h3>
                                </div>
                            </div>
                            </div>
                                    ...
                                    <div class="card-body border-bottom">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-4 col-lg-3">
                                                ...
                                                <select id="unit_id" class="form-select select2">
...
@section('script')
    <script>
        const unitListUrl = "{{ route('units.index') }}";
        const createRouteUrl = "{{ route('units.create') }}";
        const editRouteUrl = "{{ route('units.edit', ':id') }}";
        const viewRouteUrl = "{{ route('units.show', ':id') }}";
        const deleteRouteUrl = "{{ route('units.destroy', ':id') }}";
    </script>
    <script src="{{ asset('js/utils/icons.js') }}?v={{ hash_file('md5', public_path('js/utils/icons.js')) }}"></script>
    
    <script src="{{ asset('js/master/unit/index.js') }}?v={{ hash_file('md5', public_path('js/master/unit/index.js')) }}"></script>  
@endsection