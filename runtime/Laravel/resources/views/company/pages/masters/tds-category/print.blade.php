...
<head>
    <meta charset="utf-8">
    <title>Tds Category Report - Print</title>
    ...
    <main class="print-main">
        <div class="report-content page-{{ $orientation }}">
            <table class="w-100 report-table">
                ...
                <tbody>
                    @forelse($tdsCategorys as $index => $tdsCategory)
                                @php
                                $rowCountOnPage++;
                                ...
                                <tr>
                                    ...
                                    <td class="text-start ps-2" style="width: {{ $tableConfig['columns'][1]['width'] }};">
                                        {{ Str::limit($tdsCategory->category_name, 40) }}
                                    </td>
