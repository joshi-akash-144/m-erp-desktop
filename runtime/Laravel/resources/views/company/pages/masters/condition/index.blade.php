                ...
                <div class="card-body p-1 d-flex flex-wrap align-items-center justify-content-between gap-3 border-start border-4 border-primary rounded-0">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <div class="bg-primary-lt text-primary rounded-circle d-flex align-items-center justify-content-center shadow-sm" style="width: 38px; height: 38px;">
                            <i class="fs-3 fa-solid fa-square-check"></i>
                        </div>
                        <div>
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        @canany(['condition.print', 'condition.export'])
                                        <div class="dropdown">
                                            <button
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                @php
                                                    $actions = exportActions('conditions', 'condition');
                                                @endphp
                        ...
                        @can('condition.create')
                            ...
                            data-module="masters/condition/modal"
                            data-init="openConditionCreateModal">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="card border-0 border-start border-4 border-primary">
                            <div class="card-body shadow p-2">
                                <h3 class="page-title font-monospace"><i class="fa-solid fa-square-check text-primary"></i>&nbsp;Condition List</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="filterCollapse">
                        <div class="card-body border-bottom">
                            <div class="row g-3">
                                ...
                                <!-- Group Dropdown -->
                                <div class="col-md-4 col-lg-3">
                                    <label class="form-label fw-bold">Select Condition</label>
                                    <select id="condition_id" class="form-select tom-select">
...
@section('script')
    <script>
        const conditionListUrl = "{{ route('conditions.index') }}";
        const conditionCreateUrl = "{{ route('conditions.create') }}";
        const conditionEditUrl = "{{ route('conditions.edit', ':id') }}";
        const conditionViewUrl = "{{ route('conditions.show', ':id') }}";
        const conditionDeleteUrl = "{{ route('conditions.destroy', ':id') }}";
    </script>
    <script src="{{ asset('js/utils/icons.js') }}?v={{ hash_file('md5', public_path('js/utils/icons.js')) }}"></script>
    
    <script src="{{ asset('js/master/condition/index.js') }}?v={{ hash_file('md5', public_path('js/master/condition/index.js')) }}"></script>  
@endsection