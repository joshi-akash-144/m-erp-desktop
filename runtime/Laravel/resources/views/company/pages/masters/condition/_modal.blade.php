...
$title = $modalData['title'] ?? 'Add Condition';
$uuid = $modalData['uuid'] ?? '';
...
<div class="modal fade master-modal" id="condition_modal" data-bs-backdrop="static" 
     data-bs-keyboard="false" tabindex="-1" aria-labelledby="condition_modal" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-centered">
    ...
    <form id="condition_form"
      action="{{ $formMode === 'edit' ? route('conditions.update', $data->id) : route('conditions.store') }}"
        ...
        <div class="col-md-12">
          ...
          <div class="master-form-section">
            ...
            <div class="row g-2">
              <!-- Condition Name -->
              <div class="col-md-6">
                <label class="form-label required"> <i class="fa-solid fa-list-check text-secondary"></i>&nbsp;Condition Name</label>
                <input type="text" name="name" id="name" class="form-control" placeholder="{{ $isView ? '' : 'Enter Condition Name' }}"
      ...
      <div class="modal-footer master-modal-footer">
        ...
        @if(!$isView)
          <button type="submit" form="condition_form" class="btn btn-primary form-save-btn waves-effect">
...
<script src="{{ asset('js/master/condition/modal.js') }}?v={{ hash_file('md5', public_path('js/master/condition/modal.js')) }}"></script>  
