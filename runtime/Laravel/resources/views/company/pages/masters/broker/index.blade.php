            ...
            <div class="card border-0 shadow-sm rounded-0" style="background: linear-gradient(145deg, #ffffff, #f8f9fa);">
                <div class="card-body p-1 d-flex flex-wrap align-items-center justify-content-between gap-3 border-start border-4 border-primary rounded-0">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        @canany(['broker.print', 'broker.export'])
                                <div class="dropdown">
                                    <button
                            ...
                            <div class="waves-effect">
                                ...
                                data-module="masters/broker/modal"
                                data-init="openBrokerCreateModal">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <div class="card border-0 border-start border-4 border-primary">
                                <div class="card-body shadow p-2">
                                    <h3 class="page-title font-monospace"><i class="fa-solid fa-user-group text-primary"></i>&nbsp;Broker List</h3>  
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="filterCollapse">
                            <div class="card-body border-bottom">
                                <div class="row g-3">
                                    ...
                                    <!-- Group Dropdown -->
                                    {{-- <div class="col-md-4 col-lg-3">
                                        <label class="form-label">Select Acccount Name</label>
...
@section('script')
    <script>
        const brokerListUrl = "{{ route('brokers.index') }}";
        const brokerCreateUrl = "{{ route('brokers.create') }}";
        const brokerEditUrl = "{{ route('brokers.edit', ':id') }}";
        const brokerViewUrl = "{{ route('brokers.show', ':id') }}";
        const brokerDeleteUrl = "{{ route('brokers.destroy', ':id') }}";
    </script>
    <script src="{{ asset('js/utils/icons.js') }}?v={{ hash_file('md5', public_path('js/utils/icons.js')) }}"></script>
    
    <script src="{{ asset('js/master/broker/index.js') }}?v={{ hash_file('md5', public_path('js/master/broker/index.js')) }}"></script>  
@endsection