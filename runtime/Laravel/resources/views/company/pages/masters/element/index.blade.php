                ...
                <div class="card-body p-1 d-flex flex-wrap align-items-center justify-content-between gap-3 border-start border-4 border-primary rounded-0">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <div class="bg-primary-lt text-primary rounded-circle d-flex align-items-center justify-content-center shadow-sm" style="width: 38px; height: 38px;">
                            <i class="fs-3 fa-solid fa-atom"></i>
                        </div>
                        <div>
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        @canany(['element.print', 'element.export'])
                            <div class="dropdown">
                                <button
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    @php
                                        $actions = exportActions('elements', 'element');
                                    @endphp
                        ...
                        data-module="masters/element/modal"
                        data-init="openElementCreateModal">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="card border-0 border-start border-4 border-primary">
                            <div class="card-body shadow p-2">
                                <h3 class="page-title font-monospace"><i class="fa-solid fa-atom text-primary"></i>&nbsp;Element List</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="filterCollapse">
                        <div class="card-body border-bottom">
                            <div class="row g-3">
                                ...
                                <!-- Group Dropdown -->
                                <div class="col-md-4 col-lg-3">
                                    <label class="form-label fw-bold">Select Element</label>
                                    <select id="element_id" class="form-select tom-select">
...
@section('script')
    <script>
        const elementListUrl = "{{ route('elements.index') }}";
        const elementCreateUrl = "{{ route('elements.create') }}";
        const elementEditUrl = "{{ route('elements.edit', ':id') }}";
        const elementViewUrl = "{{ route('elements.show', ':id') }}";
        const elementDeleteUrl = "{{ route('elements.destroy', ':id') }}";
    </script>
    <script src="{{ asset('js/utils/icons.js') }}?v={{ hash_file('md5', public_path('js/utils/icons.js')) }}"></script>
    
    <script src="{{ asset('js/master/element/index.js') }}?v={{ hash_file('md5', public_path('js/master/element/index.js')) }}"></script>  
@endsection