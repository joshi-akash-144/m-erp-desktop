...
@section('title', 'Bank Configuration - List')
@section('css')
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="card border-0 border-start border-4 border-primary">
                            <div class="card-body shadow p-2">
                                <h3 class="page-title font-monospace"><i class="fa-solid fa-building-columns text-primary"></i>&nbsp;Bank Configuration List</h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card border-0 border-end border-4 border-primary">
                            <div class="card-body shadow-sm p-2">
                                <div class="d-flex flex-wrap justify-content-md-end justify-content-start gap-2">
                                    ...
                                    {{-- @canany(['bank_configuration.print', 'bank_configuration.export'])
                                        <div class="dropdown">
                                            <button
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                @php
                                                    $actions = exportActions('bank-configurations', 'bank_configuration');
                                                @endphp
            ...
            <div class="container-xl">
                <div class="card">
                    ...
                    <div class="card-body p-0">
                        <div id="bank_configuration_table">
...
@section('script')  
     <script>
        const bankConfigurationListUrl = "{{ route('bank-configurations.index') }}";
        const bankConfigurationCreateUrl = "{{ route('bank-configurations.create') }}"; 
        const bankConfigurationViewUrl = "{{ route('bank-configurations.show', ':id') }}";       
        const bankConfigurationEditUrl = "{{ route('bank-configurations.edit', ':id') }}";
        const bankConfigurationUpdateUrl = "{{ route('bank-configurations.update', ':id') }}";
        const bankConfigurationDeleteUrl = "{{ route('bank-configurations.destroy', ':id') }}";            
    </script>

    <script src="{{ asset('js/utils/icons.js') }}?v={{ hash_file('md5', public_path('js/utils/icons.js')) }}"></script>
    <script src="{{ asset('js/master/bank-configuration/index.js') }}?v={{ hash_file('md5', public_path('js/master/bank-configuration/index.js')) }}"></script>
@endsection
