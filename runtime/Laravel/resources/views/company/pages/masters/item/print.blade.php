                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-start ps-2" style="width: {{ $tableConfig['columns'][3]['width'] }};">
                            {{ $item->itemGroup->name ? ucfirst($item->itemGroup->name) : '-' }}
                        </td>

                        {{-- Unit --}}
                        <td class="text-start ps-2" style="width: {{ $tableConfig['columns'][4]['width'] }};">
                            {{ $item->unit->name ? ucfirst($item->unit->name) : '-' }}
                        </td>

                        {{-- Tax Category --}}
                        <td class="text-start ps-2" style="width: {{ $tableConfig['columns'][5]['width'] }};">
                            {{ $item->taxCategory->name ? ucfirst($item->taxCategory->name) : '-' }}
                        </td>

                        {{-- HSN SAC CODE --}}
                        <td class="text-start ps-2" style="width: {{ $tableConfig['columns'][6]['width'] }};">
                            {{ $item->hsn_sac_code ? ucfirst($item->hsn_sac_code) : '-' }}
                        </td>

                        {{-- OPT Stock  --}}
                        <td class="text-start ps-2" style="width: {{ $tableConfig['columns'][7]['width'] }};">
                            {{ $item->currentYearBalance?->opening_qty ? ucfirst($item->currentYearBalance?->opening_qty) : '-' }}
                        </td>

                        {{-- OPT Stock Value  --}}
                        <td class="text-start ps-2" style="width: {{ $tableConfig['columns'][8]['width'] }};">
                            {{ $item->currentYearBalance?->opening_value ? ucfirst($item->currentYearBalance?->opening_value) : '-' }}
                        </td>
                    </tr>
