...
<head>
    <meta charset="utf-8">
    <title>Dairy Parameter Report - Print</title>
...
<body>
    @php
    $reportTitle = "Dairy Parameter Report";
    ...
    <main class="print-main">
        <div class="report-content page-{{ $orientation }}">
            <table class="w-100 report-table">
                ...
                <tbody>
                    @forelse($dairyParamters as $index => $parameter)
                    @php
                    $rowCountOnPage++;
