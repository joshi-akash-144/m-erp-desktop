...
<head>
    <meta charset="utf-8">
    <title>Contractor Report - Print</title>
        ...
        <div class="report-content page-{{ $orientation }}">
            <table class="w-100 report-table">
                ...
                <tbody>
                    ...
                    <tr>
                        {{-- No. --}}
                        <td class="text-start" style="width: {{ $tableConfig['columns'][0]['width'] }};">
                            {{ $index + 1 }}.
                        </td>

                        {{-- Name --}}
                        <td class="text-start ps-2" style="width: {{ $tableConfig['columns'][1]['width'] }};">
                            {{ Str::limit($contractor->name ?? '-', 48) }}
                        </td>

                        {{-- City --}}
                        <td class="text-start" style="width: {{ $tableConfig['columns'][2]['width'] }};">
                            {{ Str::limit($contractor->city ?? '-', 29) }}
                        </td>
                    </tr>
