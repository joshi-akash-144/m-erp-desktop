                        ...
                        <div class="card-body p-1 d-flex flex-wrap align-items-center justify-content-between gap-3 border-start border-4 border-primary rounded-0">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <div class="bg-primary-lt text-primary rounded-circle d-flex align-items-center justify-content-center shadow-sm" style="width: 38px; height: 38px;">
                                    <i class="fs-3 fas fa-file-contract"></i>
                                </div>
                                <div>
                            ...
                            <div class="d-flex align-items-center gap-2">
                                @canany(['contractor.print', 'contractor.export'])
                                    <div class="dropdown">
                                        <button
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            @php
                                                $actions = exportActions('contractors', 'contractor');
                                            @endphp
                                ...
                                data-module="masters/contractor/modal"
                                data-init="openContractorCreateModal">
                    ...
                    <div id="filterCollapse">
                        <div class="card-body border-bottom">
                            <div class="row g-3">
                                ...
                                <!-- Group Dropdown -->
                                {{-- <div class="col-md-4 col-lg-3">
                                    <label class="form-label fw-bold">Select Contractor</label>
                                    <select id="contractor_id" class="form-select tom-select">
...
@section('script')
    <script>
        const contractorListUrl = "{{ route('contractors.index') }}";
        const contractorCreateUrl = "{{ route('contractors.create') }}";
        const contractorEditUrl = "{{ route('contractors.edit', ':id') }}";
        const contractorViewUrl = "{{ route('contractors.show', ':id') }}";
        const contractorDeleteUrl = "{{ route('contractors.destroy', ':id') }}";
    </script>
    <script src="{{ asset('js/utils/icons.js') }}?v={{ hash_file('md5', public_path('js/utils/icons.js')) }}"></script>
    
    <script src="{{ asset('js/master/contractor/index.js') }}?v={{ hash_file('md5', public_path('js/master/contractor/index.js')) }}"></script>  
@endsection