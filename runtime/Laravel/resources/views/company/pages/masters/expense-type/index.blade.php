                        ...
                        <div class="card-body p-1 d-flex flex-wrap align-items-center justify-content-between gap-3 border-start border-4 border-primary rounded-0">
                            ...
                            <div class="col-12 col-sm-6 col-md-4 col-lg-3 d-print-none">                                    
                                <div class="d-flex flex-wrap justify-content-md-end justify-content-start gap-2">
                                    ...
                                    {{-- @canany(['expense_type.print', 'expense_type.export'])
                                        <div class="dropdown">
                                            <button
                                                class="btn btn-outline-secondary dropdown-toggle btn-sm btn-animate-icon btn-animate-icon-pulse expense-types waves-effect"
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                @php
                                                    $actions = exportActions('expense-types', 'expense_type');
                                                @endphp
                                    ...
                                    <div class="waves-effect">
                                        ...
                                        data-init="openExpenseTypeCreateModal">
                        ...
                        <div id="filterCollapse">
                            <div class="card-body border-bottom">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4 col-lg-3">
                                        <label class="form-label fw-bold">Select Expense Type</label>
                                        <select id="expense_type_id" class="form-select">
...
@section('script')
    ...
    <script>
        const expenseTypeListUrl = "{{ route('expense-types.index') }}";
        const expenseTypeCreateUrl = "{{ route('expense-types.create') }}";
        const expenseTypeViewUrl = "{{ route('expense-types.show', ':id') }}";
        const expenseTypeEditUrl = "{{ route('expense-types.edit', ':id') }}";
        const expenseTypeDeleteUrl = "{{ route('expense-types.destroy', ':id') }}";            
    </script>

    <script src="{{ asset('js/utils/icons.js') }}?v={{ hash_file('md5', public_path('js/utils/icons.js')) }}"></script> 
    <script src="{{ asset('js/master/expense-type/index.js') }}?v={{ hash_file('md5', public_path('js/master/expense-type/index.js')) }}"></script>
@endsection
