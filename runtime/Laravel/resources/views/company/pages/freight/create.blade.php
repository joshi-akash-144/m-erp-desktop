        ...
        <div class="page-body">
            <div class="container-xl">
                <div class="card p-2 shadow-sm">
                    @include('company.pages.freight._form', ['formMode' => 'create'])
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    const storeFreightUrl = "{{ route('freight.store') }}";
    const checkDuplicateLrFromFreightModule = "{{ route('freight.checkDuplicateLRNumber') }}";
</script>

    <script src="{{ asset('js/modules/freight/create.js') }}?v={{ hash_file('md5', public_path('js/modules/freight/create.js')) }}"></script>
