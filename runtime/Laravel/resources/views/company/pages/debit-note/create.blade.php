...
@section('title', 'Debit Note – Create')
    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="card p-3 shadow-sm">
                @include('company.pages.debit-note._form', ['formMode' => 'create'])
            </div>
        </div>
    </div>
...
@include('company.partials._shortcuts-bar', [
    'barModuleLabel'     => 'Debit Note Create',
    'barModuleShortcuts' => [
...
@section('script')
<script>
    const dnStoreUrl         = "{{ route('debit-notes.store') }}";
