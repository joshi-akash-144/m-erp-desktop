        ...
        <div class="modal-content shadow border-0">
            ...
            <div class="modal-body">
                <div class="module-form-section">
                    ...
                    <div class="module-page-footer mt-0" id="view_secondary_narration_row" style="display:none;">
                        <span class="fw-bold">Cheque:</span> <span id="view_secondary_narration"
                            class="bg-white text-dark p-1">--</span>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                ...
                {{-- @can('debit_note_voucher.print-voucher')
                <a href="javascript:void(0)" type="button" class="btn btn-primary waves-effect" id="btn_print_credit_note">
                    <i class="fa-solid fa-print me-1"></i> Print Credit Note
                </a>
                @endcan --}}
