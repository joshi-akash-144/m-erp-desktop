    ...
    <div style="padding-left: 40px;padding-right: 0px">
        ...
        <div style="margin-bottom: 5px">
            ...
            <div style="display: flex;justify-content: center">
                ...
                <span style="flex:33; font-size:15px; text-align: center" class="fw-bold">Journal Voucher</span>
                <span style="flex:33; font-size:15px; text-align: end" class="fw-bold">Journal Date :{{ $voucher_date
                    }}</span>
            </div>
        </div>
        <div>
        ...
        <div style="margin-top: 10px">
            <table id="brackUpTable">
                ...
                <tr>
                    ...
                    <td style="width:27%">{{ Str::limit($breakup_data['column8'] ?? '-', 12, '...') }}</td>
