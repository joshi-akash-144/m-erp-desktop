...
@section('title', 'Debit Note Voucher Edit')
@section('css')
    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="card p-2 shadow-sm">
                @include('company.pages.debit-note-voucher._form', ['formMode' => 'edit'])
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    const editDebitNoteVoucher = "{{ route('debit-note-vouchers.edit') }}";
    const updateDebitNoteVoucher = "{{ url('/vouchers/debit-note-vouchers') }}";
</script>

@section('script')
<script src="{{ asset('js/modules/debit-note-voucher/create.js') }}?v={{ hash_file('md5', public_path('js/modules/debit-note-voucher/create.js')) }}"></script>
<script src="{{ asset('js/modules/debit-note-voucher/edit.js') }}?v={{ hash_file('md5', public_path('js/modules/debit-note-voucher/edit.js')) }}"></script>
@endsection