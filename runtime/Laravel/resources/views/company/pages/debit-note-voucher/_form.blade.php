<form id="debit_note_voucher_form" autocomplete="off" data-form-mode="create"
    action="{{ route('debit-note-vouchers.store') }}">
    ...
    <div class="grid-row m-erp-po-row-1">
        <div class="grid-item">
            ...
            <select name="" id="voucher_id" class="form-select select2">
                <option value="">Select Debit Note Voucher</option>
    ...
    <div class="row">
        <div class="col-lg-9" style="max-height: 400px; overflow-y: auto; position: relative;">
            <table class="table border border-1 border-dark-subtle table-bordered" id="debit_note_voucher_table"
                ...
                <tbody id="debit_note_voucher_table_body">
