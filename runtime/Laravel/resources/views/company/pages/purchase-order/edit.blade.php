...
@section('css')
    ...
    <style>
    .m-erp-po-row-1 {
        grid-template-columns: 200px 140px 150px 140px 1fr 1fr;
    }
    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="card p-2 shadow-sm">
                @include('company.pages.purchase-order._form', ['formMode' => 'edit'])
            </div>
        </div>
    </div>
@include('company.partials._shortcuts-bar', [
    'barModuleLabel'     => 'Purchase Order Edit',
    'barModuleShortcuts' => [
...
@endsection
        ...
        @section('script')
        <script>
            const getPurchaseOrderUrl = "{{ route('purchase-orders.show', ':id') }}";
            const updatePurchaseOrderUrl = "{{ route('purchase-orders.update', ':id') }}";
        ...
        <script src="{{ asset('js/modules/purchase-order/edit.js') }}?v={{ hash_file('md5', public_path('js/modules/purchase-order/edit.js')) }}"></script>
