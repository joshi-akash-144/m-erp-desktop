{{-- Urgent Email — multi-PO compose modal --}}
<div class="modal fade" id="urgentEmailModal" data-bs-backdrop="static" tabindex="-1" aria-labelledby="urgentEmailModalLabel">
    <div class="modal-dialog modal-xl modal-dialog-scrollable" style="max-width:1500px;">
        <div class="modal-content" style="border-radius:6px; overflow:hidden;">
            ...
            <div class="modal-header py-2 px-3" style="background:#1a3c5e;">
                <h5 class="modal-title mb-0 text-white fw-bold" id="urgentEmailModalLabel">
                    <i class="fa-solid fa-paper-plane me-2"></i> Compose Urgent Email
                </h5>
            ...
            <div class="modal-body p-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="padding:5px 8px;">
                                <input type="text" id="urgent_email_to"
                        ...
                        <tr>
                            ...
                            <td style="padding:5px 8px;">
                                <select id="urgent_email_cc" multiple style="width:100%;"></select>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="padding:5px 8px;">
                                <input type="text" id="urgent_email_subject"
                                    class="form-control form-control-sm border-0 shadow-none"
                        ...
                        <tr>
                            ...
                            <td style="padding:0; position:relative; min-height:320px;">
                                <div id="urgent_editor_loader" style="position:absolute; top:0; left:0; width:100%; height:100%; background:rgba(255,255,255,0.92); z-index:10; display:none; flex-direction:column; justify-content:center; align-items:center; gap:8px;">
                                    <i class="fa fa-spinner fa-spin fa-2x text-primary"></i>
                                    <span class="fw-semibold text-primary" style="font-size:13px; letter-spacing:0.3px;">Loading...</span>
                                </div>
                                <textarea id="urgent_email_message" name="urgent_email_message" rows="10"></textarea>
                            </td>
                        </tr>
                ...
                {{-- Hidden state --}}
                <input type="hidden" id="urgent_modal_po_ids">
            </div>
            ...
            <div class="modal-footer py-2 px-3 justify-content-end gap-2">
                ...
                <button type="button" id="urgent_email_send_btn" class="btn btn-primary waves-effect">
