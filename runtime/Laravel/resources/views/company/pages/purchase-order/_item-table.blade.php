<table class="table table-sm align-middle border mb-0">
    ...
    <tbody id="item_table_body">
        <tr data-row-id="1" class="item-row">
            ...
            <td>
                <input type="text" name="items[0][unit_name]" class="form-control form-control-sm unit_name" disabled value="--" readonly>
            </td>
            ...
            <td>
                <div class="input-icon">
                    <input type="text" name="items[0][cgst_rate]" class="form-control form-control-sm text-end cgst_rate"
                        value="--" disabled>
            ...
            <td>
                <div class="input-icon">
                    <input type="text" name="items[0][sgst_rate]" class="form-control form-control-sm text-end sgst_rate"
                        value="--" disabled>
            ...
            <td>
                <div class="input-icon">
                    <input type="text" name="items[0][igst_rate]" class="form-control form-control-sm text-end igst_rate"
                        value="--" disabled>
            ...
            <td>
                <input type="text" name="items[0][quantity]"
                       class="form-control form-control-sm text-end quantity"
                       placeholder="0.000">
            </td>

            <td>
                <input type="text" name="items[0][inclusive_rate]"
                       class="form-control form-control-sm text-end inclusive_rate"
                       placeholder="0.00">
            </td>

            <td>
                <input type="text" name="items[0][rate]"
                       class="form-control form-control-sm text-end rate"
                       placeholder="0.00">
            </td>

            <td>
                <input type="text" name="items[0][amount]"
                       class="form-control form-control-sm text-end amount bg-light non-selectable"
                       placeholder="0.00">
            </td>
        </tr>
    </tbody>
