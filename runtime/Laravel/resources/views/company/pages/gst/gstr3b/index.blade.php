...
<style>
    ...
    .gstr3b-section-row:hover .gstr3b-drill-icon {
        opacity: 1;
        color: #0d6efd;
    }

    /* Modal fullscreen */
    #gstr3bDrillModal .modal-dialog {
        max-width: 100%;
        width: 100%;
        margin: 0;
    }

    #gstr3bDrillModal .modal-content {
        border-radius: 0;
        min-height: 100vh;
    }

    #gstr3bDrillModal .modal-body {
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div class="ms-md-3">
                            <span class="badge badge-pill bg-teal text-white fw-bold text-uppercase shadow-sm px-3 py-1" style="font-size: 0.75rem; letter-spacing: 0.5px;">
                                <i class="fa-solid fa-chart-line me-1"></i> Return Summary
                            </span>
                        </div>
                    </div>
                    <div class="d-flex align-items-center gap-2">
                        <button type="button" id="btn_export_gstr3b" class="btn btn-sm btn-outline-success waves-effect d-none">
        ...
        <div class="container-xl">
            ...
            <div class="card mb-3 d-print-none">
                <div class="card-body py-2">
                    <form id="gstr3b_form" class="row g-2 align-items-end" autocomplete="off">
            ...
            <div id="report_output" class="d-none">
                ...
                <div class="card mb-3">
                    <div class="card-body p-0">
                        <div id="gstr3b_tabulator" style="font-family: 'Inter', sans-serif;"></div>
                    </div>
                </div>
...
═══════════════════════════════════════════════════════ --}}
<div class="modal fade" id="gstr3bDrillModal" tabindex="-1" aria-hidden="true">
...
@section('script')
<script>
    const GSTR3B_SUMMARY_URL = "{{ route('gstr3b-report.summary') }}";
    const GSTR3B_DETAIL_URL = "{{ route('gstr3b-report.detail') }}";
    const GSTR3B_EXPORT_EXCEL_URL = "{{ route('gstr3b-report.export.excel') }}";
    const GSTR3B_EXPORT_DETAIL_EXCEL_URL = "{{ route('gstr3b-report.export.detail.excel') }}";
...
<script src="{{ asset('js/modules/gst/gstr3b.js') }}?v={{ hash_file('md5', public_path('js/modules/gst/gstr3b.js')) }}"></script>
@endsection
