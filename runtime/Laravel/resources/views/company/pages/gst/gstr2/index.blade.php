...
<style>
    ...
    .gstr2-section-row:hover .gstr2-drill-icon {
        opacity: 1;
        color: #0d6efd;
    }

    /* Modal fullscreen */
    #gstr2DrillModal .modal-dialog {
        max-width: 100%;
        width: 100%;
        margin: 0;
    }

    #gstr2DrillModal .modal-content {
        border-radius: 0;
        min-height: 100vh;
    }

    #gstr2DrillModal .modal-body {
            ...
            <div class="card border-0 shadow-sm rounded-0" style="background: linear-gradient(145deg, #ffffff, #f8f9fa);">
                <div class="card-body p-1 d-flex flex-wrap align-items-center justify-content-between gap-3 border-start border-4 border-primary rounded-0">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        <button type="button" id="btn_export_gstr2" class="btn btn-sm btn-outline-success waves-effect d-none">
        ...
        <div class="container-xl">
            ...
            <div class="card mb-3 d-print-none">
                <div class="card-body py-2">
                    <form id="gstr2_form" class="row g-2 align-items-end" autocomplete="off">
            ...
            <div id="report_output" class="d-none">
                ...
                <div class="card mb-3">
                    <div class="card-body p-0">
                        <div id="gstr2_tabulator" style="font-family: 'Inter', sans-serif;"></div>
                    </div>
                </div>
...
═══════════════════════════════════════════════════════ --}}
<div class="modal fade" id="gstr2DrillModal" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header py-2 border-bottom border-2"
                ...
                <div class="d-flex align-items-center gap-3 flex-wrap">
                    ...
                    <div>
                        <div class="modal-section-title text-primary">HSN-wise Summary of Inward Supplies</div>
...
@section('script')
<script>
    const GSTR2_SUMMARY_URL = "{{ route('gstr2-report.summary') }}";
    const GSTR2_DETAIL_URL = "{{ route('gstr2-report.detail') }}";
    const GSTR2_EXPORT_EXCEL_URL = "{{ route('gstr2-report.export.excel') }}";
    const GSTR2_EXPORT_DETAIL_EXCEL_URL = "{{ route('gstr2-report.export.detail.excel') }}";
...
<script src="{{ asset('js/modules/gst/gstr2.js') }}?v={{ hash_file('md5', public_path('js/modules/gst/gstr2.js')) }}"></script>
@endsection
