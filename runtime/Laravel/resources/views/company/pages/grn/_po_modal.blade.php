            ...
            <div class="modal-body p-0" style="max-height: 450px; overflow-y: auto;">
                <table class="table table-hover table-sm align-middle mb-0" id="pending_po_table" autocomplete="off">
                    <thead class="table-primary sticky-top">
                        <tr>
                            <th style="width:130px" class="text-center"><i class="fas fa-hashtag me-1 text-secondary "></i> Order No</th>
                            ...
                            <th style="width:120px" class="text-end"><i class="fas fa-coins me-1 text-secondary"></i> Incl. Rate</th>
