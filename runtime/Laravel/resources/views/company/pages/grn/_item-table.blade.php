<table class="table table-sm align-middle border mb-0" id="item_table">
        ...
        <tr>
            ...
            <th style="width:140px;">
                ...
                <span class="form-help bg-primary text-white rounded-circle px-2" data-bs-toggle="popover"
                  ...
                  Use the <strong>Space key</strong> to view the PO list
                ">
    ...
    <tbody id="item_table_body">
        <tr data-row-id="1" class="item-row">
            ...
            <td>
                <div class="input-icon">
                    <input type="text" name="items[0][purchase_order_serial]" class="form-control form-control-sm purchase_order_serial"
                        placeholder="Space → Select PO">

                    <!-- Clear icon -->
                    <span class="input-icon-addon d-none clear-po" role="button" style="cursor:pointer; pointer-events:auto;">
                        ✖
                    </span>
                </div>
