...
@section('title', 'Purchase Invoice – Edit')
    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="card p-2 shadow-sm">
                @include('company.pages.purchase-invoice._form', ['formMode' => 'edit'])
            </div>
        </div>
    </div>
</div>
...
@include('company.partials._shortcuts-bar', [
    'barModuleLabel'     => 'Purchase Invoice Edit',
    'barModuleShortcuts' => [
...
<script>
    ...
    const editRoute                     = "{{ route('purchase-invoices.edit', ':id') }}";
    const updatePurchaseInvoiceUrl                   = "{{ route('purchase-invoices.update', ':id') }}";
...
<script src="{{ asset('js/modules/purchase-invoice/edit.js') }}?v={{ hash_file('md5', public_path('js/modules/purchase-invoice/edit.js')) }}"></script>
