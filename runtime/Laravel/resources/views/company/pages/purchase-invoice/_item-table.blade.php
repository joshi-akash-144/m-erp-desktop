<table class="table table-sm align-middle border mb-0" id="item_table">
    <thead class="table-light text-nowrap">
        <tr>
            ...
            <th style="width:140px;">
                <i class="fa-solid fa-file-invoice text-secondary me-1"></i> Order No.
            </th>
            ...
            <th class="text-end required" style="width:190px;">
        ...
        <tr data-row-id="1" class="item-row">
            ...
            <td>
                <div class="position-relative">
                    ...
                    <div 
                        class="d-none position-absolute top-0 start-0 w-100 h-100 bg-white bg-opacity-75 d-flex align-items-center justify-content-center item_details_loader"
                        style="z-index: 3;">
            ...
            <td>
                <div class="input-icon">
                    <input type="text" name="items[0][purchase_order_serial]"
                        class="form-control form-control-sm purchase_order_serial bg-light border-1 border-secondary-subtle"
                        placeholder="Selected PO No." tabindex="-1" readonly>
            ...
            <td>
                <input type="text" name="items[0][amount]"
                    class="form-control form-control-sm text-end amount non-selectable"
                    placeholder="0.00">
            </td>
