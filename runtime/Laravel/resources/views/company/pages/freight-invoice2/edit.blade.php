...
@section('title', 'Freight Invoice – Edit')
            ...
            <div class="card border-0 shadow-sm rounded-0" style="background: linear-gradient(145deg, #ffffff, #f8f9fa);">
                <div class="card-body p-1 d-flex flex-wrap align-items-center justify-content-between gap-3 border-start border-4 border-sales rounded-0">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div class="ms-md-3">
                            <span class="badge badge-pill bg-warning text-dark fw-bold text-uppercase shadow-sm px-3 py-1" style="font-size: 0.75rem; letter-spacing: 0.5px;">
        ...
        <div class="page-body">
            <div class="container-xl">
                <div class="card p-2 shadow-sm">
                    @include('company.pages.freight-invoice2._form',['formMode' => 'edit'])
                </div>
            </div>
        </div>
    </div>
...
@include('company.partials._shortcuts-bar', [
    'barModuleLabel'     => 'Freight Invoice Edit',
    'barModuleShortcuts' => [
...
@section('script')
    <script>
        const storeFreightInvoice2Url = "{{ route('freight-invoice2.update', $freight->id) }}";
    </script>
    <script src="{{ asset('js/modules/freight-invoice2/edit.js') }}?v={{ hash_file('md5', public_path('js/modules/freight-invoice2/edit.js')) }}"></script>
@endsection 
