                ...
                <form id="filter_form g-2">
                    <div class="p-3">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-lg-3 d-flex mt-2 align-items-end gap-2">
...
@section('script')
    <script>
        const dayToDayRegisterListUrl       = "{{ route('dairy-file-import.day-to-day.register.list') }}";
        const dayToDayRegisterDestroyUrl    = "{{ route('dairy-file-import.day-to-day.register.destroy', ':id') }}";
        const dayToDayRegisterBulkDeleteUrl = "{{ route('dairy-file-import.day-to-day.register.bulk-delete') }}";
    </script>
    <script src="{{ asset('js/utils/icons.js') }}?v={{ hash_file('md5', public_path('js/utils/icons.js')) }}"></script>    
    <script src="{{ asset('js/modules/dairy-file-import/day-to-day-register.js') }}?v={{ time() }}"></script>
@endsection
