...
<head>
    ...
    <title>Multi GRN - Print View</title>
    <style>
        body {
                        ...
                        <thead>
                            <tr>
                                <td style="font-size:18px;" class="text-center p-1" colspan="8">
                                    {{ !empty($vendor) ? $vendor->name : 'BANAS DISTRICGT CO-OPERATIVE MILK PRODUCERS UNION LTD' }}
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="font-size:16px;" class="text-end p-1">{{ $row['gross_wt'] ?? '0' }}</td>
                            </tr>
                            <tr>
                                ...
                                <td style="font-size:16px;" class="text-end p-1">{{ $row['tare_wt'] ?? '0' }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="font-size:18px;" class="text-left p-1"><b>{{ $row['no_of_bag'] ?? '0' }}</b></td>
                                ...
                                <td style="font-size:16px;" class="text-end p-1">
                                    {{ (int) ($row['gross_wt'] ?? 0) - (int) ($row['tare_wt'] ?? 0) }}</td>
                            </tr>
                            <tr>
                                <td style="font-size:16px;" class="text-left p-1"></td>
                                <td style="font-size:16px;" class="text-left p-1"></td>
                            ...
                            <tr>
                                ...
                                <td style="font-size:18px;" class="text-left p-1"><b>{{ $row['nt_wt_wo_bag'] ?? '0' }}</b>
                                </td>
                                <td style="font-size:16px;" class="text-left p-1"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="font-size:16px;" class="text-left p-1"><b
                                        style="font-size: 30px;">{{ $row['no_of_bag'] ?? '0' }}</b>
                                </td>
                                <td style="font-size:16px;" class="text-left p-1"></td>
                                <td style="font-size:16px;" class="text-end p-1">
                                    <b style="font-size: 30px;">{{ $row['nt_wt_wo_bag'] ?? '0' }}</b>
                                </td>
                            </tr>
                        </thead>
                    </table>
