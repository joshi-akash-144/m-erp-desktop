...
@section('title', 'Mobile GRN – Create')
            ...
            <div class="card border-0 shadow-sm rounded-0" style="background: linear-gradient(145deg, #ffffff, #f8f9fa);">
                <div class="card-body p-1 d-flex flex-wrap align-items-center justify-content-between gap-3 border-start border-4 border-primary rounded-0">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        @can('mobile_grn.update')
                            <a href="{{ route('mobile-grns.edit') }}" class="btn btn-sm btn-outline-primary waves-effect rounded-0 fw-medium shadow-sm"
                                data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit Mobile GRN">
                        ...
                        <div class="card border-0 border-end border-4 border-primary">
                            <div class="card-body shadow-sm p-2">
                                <div class="d-flex flex-wrap justify-content-md-end justify-content-start gap-2">
                                    <a href="{{ route('mobile-grns.edit') }}" class="btn btn-sm btn-outline-primary"
        ...
        <div class="page-body">
            <div class="container-xl">
                <div class="card p-2 shadow-sm">
                    @include('company.pages.mobile-grn._form', ['formMode' => 'create'])
                </div>
            </div>
        </div>
    </div>
