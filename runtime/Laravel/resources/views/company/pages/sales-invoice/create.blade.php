...
<link rel="stylesheet" href="{{ asset('css/module/index.css') }}?v={{ hash_file('md5', public_path('css/module/index.css')) }}"></link>
    {{-- @vite(['resources/css/modules/index.css']) --}}
    <style>
        .m-erp-so-row-1 {
                ...
                <div class="card-body p-1 d-flex flex-wrap align-items-center justify-content-between gap-3 border-start border-4 border-sales rounded-0">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        @can('sales_invoice.update')
                            <a href="{{ route('sales-invoices.edit') }}" class="btn btn-sm btn-outline-primary"
        ...
        <div class="page-body">
            <div class="container-xl">
                <div class="card p-2 shadow-sm">
                    @include('company.pages.sales-invoice._form', ['formMode' => 'create'])
                </div>
            </div>
        </div>
    </div>
...
@include('company.partials._shortcuts-bar', [
    'barModuleLabel'     => 'Sales Invoice Create',
    'barModuleShortcuts' => [
...
@section('script')
    <script>
        ...
        const updateSalesInvoiceUrl   = "{{ url('vouchers/sales-invoices') }}/:id";
