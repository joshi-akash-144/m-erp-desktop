...
@section('title', 'Godown Analysis Register')
            ...
            <div class="card border-0 shadow-sm rounded-0" style="background: linear-gradient(145deg, #ffffff, #f8f9fa);">
                <div class="card-body p-1 d-flex flex-wrap align-items-center justify-content-between gap-3 border-start border-4 border-primary rounded-0">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        @canany(['godown_analysis.print', 'godown_analysis.export'])
                            <div class="dropdown">
                                <button
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    @php
                                        $actions = exportActions('godown-analysis', 'godown_analysis');
                                    @endphp
                        ...
                        @can('godown_analysis.create')
                        <a href="{{ route('godown-analysis.create') }}"
                            class="btn btn-outline-primary btn-sm"
                            id="addGodownAnalysisBtn">
        ...
        <div class="container-xl">
            <div class="card">
                ...
                <form>
                    <div class="p-3">
                        <div class="row g-2" id="filters">
                            ...
                            <div class="col-md-4 col-lg-2">
                                <label class="filter-label fw-bold">GRN Number</label>
                                <select id="grn_id" class="form-select select2" data-placeholder="Select GRN Number">
                ...
                <div class="card-body p-0">
                    <div id="godown_analysis_table"></div>
                </div>
            </div>
        </div>
    </div>
...
@section('script')
    <script>
        const getRegisterDataUrl = "{{ route('godown-analysis.index') }}";      
        const editAnalysisUrl = "{{ route('godown-analysis.index') }}"; // Update to edit route later if needed
        const deleteAnalysisUrl = "{{ route('godown-analysis.destroy',':id') }}";
    </script>
    <script src="{{ asset('js/modules/godown-analysis/index.js') }}?v={{ hash_file('md5', public_path('js/modules/godown-analysis/index.js')) }}"></script>
