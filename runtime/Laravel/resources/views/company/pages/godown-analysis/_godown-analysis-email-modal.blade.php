{{-- Godown Analysis --}}
<div class="modal fade" id="EmailModal" data-bs-backdrop="static" tabindex="-1" aria-labelledby="EmailModalLabel">
    <div class="modal-dialog modal-xl modal-dialog-scrollable" style="max-width:1500px;">
        <div class="modal-content" style="border-radius:6px; overflow:hidden;">
            ...
            <div class="modal-header py-2 px-3" style="background:#1a3c5e;">
                <h5 class="modal-title mb-0 text-white fw-bold" id="EmailModalLabel">
            ...
            <div class="modal-body p-0">
                <table class="table table-bordered mb-0" style="font-size:13px; table-layout:fixed;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="padding:5px 8px;">
                                <select id="email_cc" multiple style="width:100%;"></select>
                            </td>
                        </tr>
                        ...
                        <!-- <tr>
                            ...
                            <td style="padding:8px 10px;">
                                <input type="file" id="email_attachment" class="form-control form-control-sm">
                            </td>
                        </tr> -->
                        ...
                        <tr>
                            ...
                            <td style="padding:0; position:relative; min-height:320px;">
                                <div id="editor_loader" style="position:absolute; top:0; left:0; width:100%; height:100%; background:rgba(255,255,255,0.92); z-index:10; display:none; flex-direction:column; justify-content:center; align-items:center; gap:8px;">
                ...
                {{-- Hidden state --}}
                <input type="hidden" id="modal_godown_analysis_id">
            </div>
            ...
            <div class="modal-footer py-2 px-3 justify-content-end gap-2">
                ...
                <button type="button" id="email_send_btn" class="btn btn-primary waves-effect">
