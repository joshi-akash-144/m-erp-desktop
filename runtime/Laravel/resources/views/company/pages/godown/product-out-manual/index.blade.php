...
@section('title', 'Godown – Product Out Manual')
@section('css')
            ...
            <div class="card border-0 shadow-sm rounded-0" style="background: linear-gradient(145deg, #ffffff, #f8f9fa);">
                <div class="card-body p-1 d-flex flex-wrap align-items-center justify-content-between gap-3 border-start border-4 border-godown rounded-0">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        @can('godown_module.product_in_manual')
                            <a href="{{ route('godown-module.product-in-manual') }}" class="btn btn-sm btn-outline-primary"
                                data-bs-toggle="tooltip" data-bs-placement="bottom" title="Product In Manual">
                                <i class="fa-solid fa-door-open me-1"></i> Product In Manual
                            </a>
                        @endcan
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                               ...
                                               <td class="spacer-cell"></td>
                                                ...
                                                <td class="input-cell">
                                                   <input type="number" step="0.001" id="gross_weight" name="gross_weight" class="form-control weight-input text-end" value="0.000">
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="input-cell">
                                                    <input type="text" name="date_out" id="date_out" class="form-control date-format text-dark disabled"  readonly value="{{ date('d-m-Y') }}">
                                                </td>
                                                <td class="spacer-cell"></td>
                                                <td class="label-cell">Net-Weight:</td>
                                                <td class="input-cell">
                                                    <input type="number" step="0.001" id="net_weight" name="net_weight" class="form-control text-end" value="0.000">
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="input-cell">
                                                    <input type="number" step="0.001" id="net_weight_wt_bag" name="net_weight_wt_bag" class="form-control text-end" value="0.000">
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div class="card-footer bg-light border-top p-3 mt-4">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <button type="submit" class="btn btn-godown form-save-btn px-5 shadow-sm waves-effect">
...
@include('company.partials._shortcuts-bar', [
    'barModuleLabel'     => 'Product Out Manual',
    'barModuleShortcuts' => [
        ['key' => 'Alt+I', 'label' => 'Product In Manual', 'type' => 'info', 'permission' => 'godown_module.product_in_manual', 'url' => route('godown-module.product-in-manual')],
...
<script>
    ...
    $(document).ready(function() {
        function printLastGodownEntry(type) {
            ...
            if (!lastId) {
                showToast('warning', 'No product out manual entry found to print.');
                return;
            }
