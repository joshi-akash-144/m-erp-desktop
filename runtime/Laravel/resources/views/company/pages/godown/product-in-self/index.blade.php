...
@section('title', 'Godown – Product In')
@section('css')
    ...
    .m-erp-po-row-1 {
        grid-template-columns: 150px 150px 0.6fr 0.8fr 1.25fr 0.5fr 130px 0.6fr;
    }
        .m-erp-godown-row-2 { grid-template-columns: 0.4fr 0.4fr 0.4fr 0.4fr 0.4fr 0.5fr 0.5fr 0.5fr; }
        ...
        @media (max-width: 992px) {
            .m-erp-godown-row-1, .m-erp-godown-row-2,.m-erp-godown-row-weight {
...
@section('content')
  ...
  <div class="page-header d-print-none">
            ...
            <div class="card border-0 shadow-sm rounded-0" style="background: linear-gradient(145deg, #ffffff, #f8f9fa);">
                <div class="card-body p-1 d-flex flex-wrap align-items-center justify-content-between gap-3 border-start border-4 border-godown rounded-0">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        {{-- @can('self.product_out')
                            <a href="{{ route('godown-module.product-out-self') }}" class="btn btn-sm btn-outline-primary"
                                data-bs-toggle="tooltip" data-bs-placement="bottom" title="Product Out">
                                <i class="fa-solid fa-door-closed me-1"></i> Product Out
                            </a>
                        @endcan --}}
      ...
      {{--   <div class="page-header d-print-none">
                        ...
                        <div class="card border-0 border-end border-4 border-godown">
                            <div class="card-body shadow-sm p-2">
                                <div class="d-flex flex-wrap justify-content-md-end justify-content-start gap-2">
                                    @can('godown_module.product_out')
                                        <a href="{{ route('godown-module.product-out-self') }}" class="btn btn-sm btn-outline-primary"
                                            data-bs-toggle="tooltip" data-bs-placement="bottom" title="Product Out Self">
                                            <i class="fa-solid fa-door-closed me-1"></i> Product Out Self
                                        </a>
                                    @endcan
                                    <a href="{{ route('back.to.previous') }}" class="btn btn-sm btn-outline-dark back-btn">
                                        <i class="fa-solid fa-arrow-left me-1"></i> Back
        ...
        <div class="page-body">
            <div class="container-xl">
                <form id="product_in_form" autocomplete="off" class="card shadow-sm">
                    @csrf
                        ...
                        <div class="module-form-section border-godown section-godown">
                            ...
                            <div class="grid-row m-erp-po-row-1 row-body">
                                <div class="grid-item">
                                    ...
                                    {{-- <select name="grn_serial" id="grn_serial" class="form-select select2"
                                        <option value="">Select GRN No</option>
                                        @foreach ($grn_serial as $value => $grn_no)
                                            <option value="{{ $value }}">{{ $grn_no }}</option>
                                        @endforeach
                                    </select>  --}}
                                    <input type="number" name="grn_serial" id="grn_serial"  class="form-control fw-bold text-dark bg-light disabled" readonly>
                                </div>
                                <div class="grid-item">
                                ...
                                <div class="grid-item">
                                    ...
                                    {{--  <button class="btn btn-godown fw-bold px-2 non-selectable" type="button" id="btn_get_vehicles" data-bs-toggle="modal" data-bs-target="#vehicle_list_modal">
                                ...
                                <div class="grid-item">
                                    ...
                                    <!-- <input type="text" name="item_id" id="item_id" class="form-control text-dark disabled"  readonly> -->

                                </div>
                                <div class="grid-item">
                                    <label class="form-label required">Name Of Party</label>
                                    <select name="party_id" id="party_id" class="form-select select2" style="text-wrap: wrap-ellipsis;">
                                ...
                                <div class="grid-item">
                                    ...
                                    <input type="text" name="grn_type" id="grn_type" class="form-control bg-primary-lt text-dark" value="" readonly>
                                </div>
                                {{-- <div class="grid-item">
                                    <label class="form-label required">Party Delivery Destination</label>
                        ...
                        <div class="module-form-section border-godown section-godown">
                            ...
                            <div class="grid-row m-erp-godown-row-2 row-body">
                                ...
                                <div class="grid-item">
                                    <label class="form-label">Bags</label>
                                        ...
                                        <input type="text" name="bag_type" id="bag_type" class="form-control text-dark disabled" readonly>
                                </div>
                                <div class="grid-item">
                                    <label class="form-label">Bag Qty</label>
                                    <div class="input-group">
                                        <input type="number" name="bag_qty" id="bag_qty" class="form-control text-dark disabled" value="0.00" readonly>
                                    </div>
                                </div>
                                <div class="grid-item">
                                    <label class="form-label">Rate</label>
                                    <input type="number" step="0.001" name="rate" id="rate" class="form-control text-end" value="0.000">
                                </div>
                                <div class="grid-item">
                                    <label class="form-label">Challan Date</label>
                                    <input type="text" name="challan_date" id="challan_date" class="form-control date-format" placeholder="DD-MM-YYYY">
                                </div>
                      
                                {{-- <div class="grid-item">
                                    <label class="form-label">P.O. No.</label>
                                    <select name="po_no" id="po_no" class="form-select select2">
                            ...
                            <div class="grid-row m-erp-godown-row-2 row-body">
                                <div class="grid-item">
                                    ...
                                    <input type="text" name="is_crossing" id="is_crossing" class="form-control text-dark disabled" readonly>
                                ...
                                <div class="grid-item">
                                    <div class="d-flex align-items-end gap-2">
                                        <div class="flex-grow-1">
                                            ...
                                            <input type="text" name="transporter_id" id="transporter_id" class="form-control text-dark disabled" readonly>
                                ...
                                <div class="grid-item">
                                    ...
                                    <div class="input-icon mb-3">
                                        <input type="text" name="lr_number" id="lr_number" class="form-control text-dark disabled" readonly>
                                        <span class="input-icon-addon d-none" id="lr_number_loader">
                                            <div class="spinner-border spinner-border-sm text-secondary" role="status"></div>
                                        </span>
                                    </div>
                                </div>
                                <!-- TODO: Add Instruction hear always input must be in kg-->
                                <div class="grid-item"> 
                                    <label class="form-label">Challan Weight</label>
                                    <input type="number" step="0.001" name="challan_weight" id="challan_weight" class="form-control" placeholder="Party Challan (In KG)">
                                </div>
                                <div class="grid-item">
                                    <label class="form-label required">Challan Bags</label>
                                    <input type="number" name="challan_bags" id="challan_bags" class="form-control">
                                </div>
                                {{-- <div class="grid-item">
                                    <label class="form-label">Is Cycle</label>
                                    <select name="is_cycle" id="is_cycle" class="form-select select2">
                                ...
                                <div class="grid-item">
                                    ...
                                    <select name="is_manual" id="is_manual" class="form-select select2">
                                        <option value="0">No</option>
                                        <option value="1">Yes</option>
                                    </select>
                                </div> --}}
                                    ...
                                    <table class="weight-table">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="input-cell">
                                                    <input type="text" name="date_in" id="date_in" class="form-control date-format disabled" value="{{ date('d-m-Y') }}" readonly>
                                                </td>
                                                <td class="spacer-cell"></td>
                                                <td class="label-cell">Gross-Weight:</td>
                                                <td class="input-cell">
                                                    <input type="number" step="0.001" id="gross_weight" name="gross_weight" class="form-control text-end disabled" value="0.000" readonly>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="input-cell">
                                                    <input type="text" name="time_in_display" class="form-control disabled" value="{{ date('h:i A') }}" readonly>
                                                </td>
                                                <td class="spacer-cell"></td> 
                                                ...
                                                <td class="input-cell">
                                                    <input type="number" step="0.001" id="tare_weight" name="tare_weight" class="form-control text-end disabled" value="0.000" readonly>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="input-cell">
                                                    <input type="text" name="grn_out_date" id="grn_out_date" class="form-control date-format disabled"  readonly value="{{ date('d-m-Y') }}">
                                                </td>
                                                <td class="spacer-cell"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="input-cell">
                                                    <input type="text" name="time_out_display" class="form-control disabled" value="{{ date('h:i A') }}" readonly>
                                                </td>
                                                <td class="spacer-cell"></td>
                                            ...
                                            <tr>
                                                <td class="p-0">
                                                    <button type="button" id="btn_moisture" class="btn-weight-action btn-godown non-selectable">
...
@section('script')
<script>
    const productInSelfUpdateUrl = "{{ route('godown-module.update-product-in-self', ':id') }}"; 
    
    const getGodownsUrl = "{{ route('godown-module.get-godowns') }}";
    const fetchGrnDetailsUrl = "{{ route('godown-module.fetch-grn-details') }}";
    const fetchWeightUrl = "{{ route('weight_location.fetch-weight', ':id') }}";
    const fetchPendingPurchaseOrdersUrl = "{{ route('grns.pending_purchase_orders') }}";
    const checkDuplicateReferenceFromGodownModule = "{{ route('grns.check_duplicate_reference') }}";
    const checkDuplicateLrFromGodownModule = "{{ route('godown-module.check_duplicate_lr') }}";
    const godownIndex = "{{ route('godown-module.index') }}";

</script>
    <script src="{{ asset('js/modules/godown/product-in-self.js') }}?v={{ hash_file('md5', public_path('js/modules/godown/product-in.js')) }}"></script>
