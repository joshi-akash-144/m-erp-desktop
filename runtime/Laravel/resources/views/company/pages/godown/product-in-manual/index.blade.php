...
@section('title', 'Godown – Product In Manual')
@section('css')
            ...
            <div class="card border-0 shadow-sm rounded-0" style="background: linear-gradient(145deg, #ffffff, #f8f9fa);">
                <div class="card-body p-1 d-flex flex-wrap align-items-center justify-content-between gap-3 border-start border-4 border-godown rounded-0">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        @can('godown_module.product_out_manual')
                            <a href="{{ route('godown-module.product-out-manual') }}" class="btn btn-sm btn-outline-primary"
                                data-bs-toggle="tooltip" data-bs-placement="bottom" title="Product Out Manual">
                                <i class="fa-solid fa-door-closed me-1"></i> Product Out Manual
                            </a>
                        @endcan
        ...
        <div class="page-body">
            <div class="container-xl">
                <form id="product_in_form" autocomplete="off" class="card shadow-sm">
                    ...
                    <input type="hidden" name="in_out_status" value="in">
                        ...
                        <div class="module-form-section border-godown section-godown">
                            ...
                            <div class="grid-row m-erp-godown-row-2 row-body">
                                ...
                                <div class="grid-item">
                                    ...
                                    <input type="number" step="0.001" name="challan_weight" id="challan_weight" class="form-control text-end" value="0.000">
                                </div>
                                    ...
                                    <table class="weight-table">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="input-cell">
                                                    <input type="text" name="grn_out_date" id="grn_out_date" class="form-control date-format text-dark disabled" value="{{ date('d-m-Y') }}" readonly>
                                                </td>
                                                <td class="spacer-cell"></td>
                                                <td class="label-cell">Net-Weight:</td>
                                                <td class="input-cell">
                                                    <input type="number" step="0.001" id="net_weight" name="net_weight" class="form-control text-end" value="0.000" readonly>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="input-cell">
                                                    <input type="number" step="0.001" id="net_weight_wt_bag" name="net_weight_wt_bag" class="form-control text-end" value="0.000" readonly>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
...
@include('company.partials._shortcuts-bar', [
    'barModuleLabel'     => 'Product In Manual',
    'barModuleShortcuts' => [
        ['key' => 'Alt+O', 'label' => 'Product Out Manual', 'type' => 'info', 'permission' => 'godown_module.product_out_manual', 'url' => route('godown-module.product-out-manual')],
...
@section('script')
    ...
    $(document).ready(function() {
        function printLastGodownEntry(type) {
            ...
            if (!lastId) {
                showToast('warning', 'No product in manual entry found to print.');
                return;
            }
