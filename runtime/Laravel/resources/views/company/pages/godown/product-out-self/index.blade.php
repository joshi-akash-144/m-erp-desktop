...
@section('css')
    ...
    .m-erp-po-row-1 {
        grid-template-columns: 150px 150px 0.6fr 0.8fr 1.25fr 0.5fr 0.7fr;
    }
        .m-erp-godown-row-2 { grid-template-columns: 0.5fr 0.5fr 0.6fr 0.6fr 0.6fr 0.6fr 0.5fr 0.5fr; }
            ...
            <div class="card border-0 shadow-sm rounded-0" style="background: linear-gradient(145deg, #ffffff, #f8f9fa);">
                <div class="card-body p-1 d-flex flex-wrap align-items-center justify-content-between gap-3 border-start border-4 border-godown rounded-0">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        {{-- @can('self.product_in')
                            <a href="{{ route('godown-module.product-in-self') }}" class="btn btn-sm btn-outline-primary"
                            ...
                            <div class="card-body shadow-sm p-2">
                                <div class="d-flex flex-wrap justify-content-md-end justify-content-start gap-2">
                                    @can('godown_module.product_in')
                                        <a href="{{ route('godown-module.product-in-self') }}" class="btn btn-sm btn-outline-primary"
                                            data-bs-toggle="tooltip" data-bs-placement="bottom" title="Product Self In">
                                            <i class="fa-solid fa-door-open me-1"></i> Product Self In
                                        </a>
                                    @endcan
                                    <a href="{{ route('back.to.previous') }}" class="btn btn-sm btn-outline-dark back-btn">
                                        <i class="fa-solid fa-arrow-left me-1"></i> Back
                        ...
                        <div class="module-form-section border-godown section-godown">
                            ...
                            <div class="grid-row m-erp-po-row-1 row-body">
                                <div class="grid-item">
                                    ...
                                    {{-- <select name="dc_serial" id="dc_serial" class="form-select select2">
                                        <option value="">--Select Challan No--</option>
                                        @foreach ($grn_serial as $value => $grn_no)
                                            <option value="{{ $value }}">{{ $grn_no }}</option>
                                        @endforeach
                                    </select> --}}
                                    <input type="number" name="dc_serial" id="dc_serial"  class="form-control text-dark bg-light disable" readonly >
                                </div>
                                <div class="grid-item">
                                ...
                                <div class="grid-item">
                                    ...
                                    <div class="input-group" style="height:35px !important;">
                                        <input type="text" name="vehicle_number" id="vehicle_number" class="form-control txtRegNo" placeholder="ENTER VEHICLE NO.">
                                    </div>
                                </div>
                                <!-- <div class="grid-item">
                        ...
                        <div class="module-form-section border-godown section-godown">
                            ...
                            <div class="grid-row m-erp-godown-row-2 row-body">
                                ...
                                <div class="grid-item">
                                    ...
                                    <input type="text" name="bag_type" id="bag_type" class="form-control text-dark text-capitalize disabled" readonly>
                                </div>
                                <div class="grid-item">
                                ...
                                {{-- <div class="grid-item">
                                    <label class="form-label required">Is Cycle</label>
                                    <div class="input-icon mb-3">
                                ...
                                <div class="grid-item">
                                    <label class="form-label required">Is Manual</label>
                                    <div class="input-icon mb-3">
                                    ...
                                    <table class="weight-table">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="input-cell">
                                                    <input type="number" step="0.001" id="gross_weight" name="gross_weight" class="form-control text-end weight-input disabled" value="0.000" readonly>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="input-cell">
                                                    <input type="text" name="date_out" id="date_out" class="form-control date-format disabled" value="{{ date('d-m-Y') }}" readonly>
                                                </td>
                                                <td class="spacer-cell"></td>
...
@section('script')
<script>
    const productOutUpdateUrl = "{{ route('godown-module.update-product-out-self', ':id') }}"; 
    ...
    <script src="{{ asset('js/modules/godown/product-out-self.js') }}?v={{ hash_file('md5', public_path('js/modules/godown/product-out-self.js')) }}"></script>
