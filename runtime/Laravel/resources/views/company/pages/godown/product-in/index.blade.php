...
@section('css')
    ...
    .m-erp-po-row-1 {
        grid-template-columns: 0.8fr 0.9fr 1.5fr 1.5fr 2fr 1fr;
    }
        .m-erp-godown-row-2 { grid-template-columns: 1fr 1fr 1fr 1fr 1fr 1.5fr ; }
        .m-erp-godown-row-3 { grid-template-columns: 2fr 1.5fr 1fr 2fr 1fr 1.5fr ; }
        .m-erp-godown-row-3.no-godown-unit { grid-template-columns: 2fr 1fr 2fr 1fr 1.5fr ; }
        .grid-item {
            position: relative;
            padding-bottom: 12px;
        }
                ...
                <div class="card-body p-1 d-flex flex-wrap align-items-center justify-content-between gap-3 border-start border-4 border-godown rounded-0">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        @can('godown_module.product_out')
                            <a href="{{ route('godown-module.product-out') }}" class="btn btn-sm btn-outline-primary"
                        ...
                        <div class="module-form-section border-godown section-godown">
                            ...
                            <div class="grid-row m-erp-po-row-1 row-body">
                                <div class="grid-item">
                                    ...
                                    <input type="text" name="grn_serial" id="grn_serial" class="form-control bg-primary-lt text-dark" value="{{ $last_grn_serial }}" readonly>
                                </div>
                                <div class="grid-item">
...
{{-- TODO: GRN Out Date must be greater than or equal to GRN In Date --}}
                                    ...
                                    <table class="weight-table">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="input-cell">
                                                    <input type="text" name="date_in" id="date_in" class="form-control date-format text-dark disabled" value="{{ date('d-m-Y') }}" readonly>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="input-cell">
                                                    <input type="text" name="grn_out_date" id="grn_out_date" class="form-control date-format text-dark disabled"  readonly value="{{ date('d-m-Y') }}">
                                                </td>
                                                <td class="spacer-cell"></td>
                                                <td class="label-cell">Gross-Weight:</td>
                                                <td class="input-cell">
                                                    <input type="number" step="0.001" id="gross_weight" name="gross_weight" class="form-control text-end weight-input disabled" readonly value="0.000">
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="input-cell">
                                                    <input type="number" step="0.001" id="tare_weight" name="tare_weight" class="form-control text-end weight-input" value="0.000">
                                                </td>
                                            </tr>
...
@include('company.pages.godown.product-in._modal')
@include('company.partials._shortcuts-bar', [
    'barModuleLabel'     => 'Product In',
    'barModuleShortcuts' => [
        ['key' => 'Alt+O', 'label' => 'Product Out', 'type' => 'info', 'permission' => 'godown_module.product_out', 'url' => route('godown-module.product-out')],
...
@section('script')
<script>
    const productInStoreUrl = "{{ route('godown-module.store-product-in') }}";
    const productInUpdateUrl = "{{ route('godown-module.update-product-in', ':id') }}"; 
    ...
    $(document).ready(function() {
        function printLastGodownEntry(type) {
            ...
            if (!lastId) {
                showToast('warning', 'No product in entry found to print.');
                return;
            }
    ...
    <script src="{{ asset('js/modules/godown/product-in.js') }}?v={{ hash_file('md5', public_path('js/modules/godown/product-in.js')) }}"></script>
