...
@php
    $route = $formMode === 'create' ? route('delivery-challans.store') : '';
@endphp

<form action="{{ $route }}" id="delivery_challan_form" autocomplete="off" data-form-mode="{{ $formMode }}" method="POST">
        ...
        <div class="grid-row m-erp-po-row-1 row-body">
            <div class="grid-item">
                <label class="form-label required">
                    <i class="fa-solid fa-hashtag me-1 text-secondary"></i> D.C. No.
                </label>
                 @if ($formMode === 'edit')
                    <select name="" id="challan_id" class="form-select select2">
                        <option value="">--Select Challan --</option>
                        @foreach ($challanSerials as $serial)
                            <option value="{{ $serial->id }}" @if ($serial->id == $challanId) selected @endif>
                                {{ $serial->challan_serial }}
                            </option>
                        @endforeach 
                    </select>
                @else 
                    <input type="text" name="challan_number" id="challan_number" class="form-control bg-primary-lt text-dark"
                        placeholder="Challan Number" value="{{ $challanNumber }}" disabled>
                @endif 
            ...
            <div class="grid-item">
                <label class="form-label required">
                    <i class="fa-regular fa-calendar-days me-1 text-secondary"></i>D.C. Date
                </label>
                <input type="text" name="challan_date" id="challan_date" class="form-control date-format"
            ...
            {{-- <div class="grid-item">
                <label class="form-label required">
                    <i class="fa-regular fa-calendar-days me-1 text-secondary"></i> Challan In Date
                </label>
                <input type="text" name="challan_in_date" id="challan_in_date" class="form-control date-format"
                    placeholder="DD-MM-YYYY">
            </div> --}}

            {{-- <div class="grid-item">
                <label class="form-label">
                    <i class="fa-regular fa-calendar-days me-1 text-secondary"></i> Challan Out Date
                </label>
                <input type="text" name="challan_out_date" id="challan_out_date" class="form-control date-format"
                    placeholder="DD-MM-YYYY">
            </div> --}}
    ...
    <div class="module-form-section section-sales border-sales">
        <div class="d-flex justify-content-between">
            ...
            <div>
                <button id="add_delivery_challan_item_row" type="button" class="btn btn-primary btn-sm fw-bold non-selectable waves-effect"
                    data-bs-toggle="tooltip" data-bs-placement="top" data-bs-html="true"
                    title="Shortcut: <strong>Alt + N</strong>" tabindex="-1">
        ...
        <div class="table-scroll-x" style="overflow-x:scroll">
            @include('company.pages.delivery-challan._item-table')
        </div>
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    ============================ -->
                            <div class="col-lg-4 col-md-6 col-12">
                                ...
                                <div class="module-form-section section-sales border-sales">
                                    <div class="module-page-title mb-3s text-sales">
                                        <i class="fa-solid fa-boxes-stacked me-2"></i>
                        ...
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                            ...
                            <div class="d-flex gap-2">
                                <button type="button" class="btn btn-outline-secondary waves-effect non-selectable"
                                    ...
                                    <!-- TODO: synchronize with all forms  -->
                                </button>
