<div class="modal fade" id="delivery_challan_modal" tabindex="-1" aria-labelledby="delivery_challan_modal_label" aria-hidden="true">
        ...
        <div class="modal-content border-0 shadow-lg" style="background: linear-gradient(135deg, #f8f9fa 0%, #ffffff 100%);">
            ...
            {{-- <div class="modal-header border-0 bg-gradient" style="background: linear-gradient(135deg, #f8f9fa 0%, #f0f2f5 100%); padding: 1rem;">
                <div class="d-flex align-items-center flex-grow-1">
                    ...
                    <div>
                        <h4 class="modal-title fw-bold mb-0 text-prima" id="delivery_challan_modal_label" style="font-size: 1.2rem; color: #1a1a2e;">
            ...
            <div class="modal-body" style="background: linear-gradient(135deg, #f8f9fa 0%, #ffffff 100%); padding: 0.5rem;">
                ...
                <form action="" id="delivery_challan_form" autocomplete="off" data-form-mode="{{ $formMode }}">
                        ...
                        <div class="row g-2">
                            <div class="col-lg-1 col-md-6 col-12 ">
                                <label class="form-label" >
                                    <i class="fa-solid fa-hashtag me-2 text-secondary"></i>D.C. No
                                </label>
                                    @if ($formMode === 'view')
                                        <input type="text" id="dc_id" class="form-control fs-1 fw-bold text-muted bg-light border-1 border-secondary-subtle" disabled>
                                    @else
                                        <input type="text" name="dc_number" id="dc_number" class="form-control fs-1 fw-bold text-muted bg-light border-1 border-secondary-subtle">{{ $dcNumber }}
                                    @endif
                            </div>

                            <div class="col-lg-1 col-md-6 col-12">
                                <label class="form-label">
                                    <i class="fa-regular fa-calendar-days me-2 text-secondary"></i>D.C. Date
                                </label>
                                <input type="text" id="delivery_challan_date" class="form-control fs-1 fw-bold text-muted bg-light border-1 border-secondary-subtle" disabled>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-12">
                                <label class="form-label">
                                    <i class="fa-solid fa-truck-field me-2 text-secondary"></i>Customer Name 
                                </label>
                            ...
                            <div class="col-lg-1 col-md-6 col-12">
                                ...
                                <span id="delivery_challan_status_view" class="alert p-2 d-block text-center text-muted fw-bold fs-3 fw-bold w-51 h-51">
                            ...
                            <table class="table  table-sm align-middle border-0 mt-0" id="item_table">
                                ...
                                <tbody id="item_table_body">
                                    <tr data-row-id="1" class="item-row">
                                        ...
                                        <td class="fw-bolder">
                                             <span class="sales_order_serial form-control form-control-sm fw-bold fs-3 text-muted bg-light border-1 border-secondary-subtle text-center" name="items[0][sales_order_serial]" disabled></span>                                                
                                             <input type="hidden" name="items[0][sales_order_id]" class="sales_order_id">
