...
@section('title', 'Delivery Challan – Edit')
...
@section('css')
    ...
    <style>
        ...
        .text-brown{
            color:#A06340 !important;
        }
        .border-brown{
            border-color:#A06340 !important;
        }
        .section-brown{
        color: #A06340 !important; 
        background-color: rgba(160, 99, 64, 0.14) !important;
        }
        .btn-brown{
            background:linear-gradient(90deg,#A06340,#D98F66) !important;
            color: #fff;
        }
       .btn-brown:hover{
            color: #fff;
            ...
            <div class="container-xl">
                <div class="row g-2 align-items-center justify-content-between">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="card border-0 border-start border-4 border-brown">
                            <div class="card-body shadow p-2">
                                <h3 class="page-title font-monospace text-brown">
                        ...
                        <div class="card border-0 border-end border-4 border-primary">
                            <div class="card-body shadow-sm p-2">
                                <div class="d-flex flex-wrap justify-content-md-end justify-content-start gap-2">
                                    @can('delivery_challan.print')
                                    <a class="btn btn-sm btn-outline-primary waves-effect" href="{{ route('back.to.previous') }}" onclick="printChallan($('#challan_id').val())" id="print_challan_btn">
        ...
        <div class="page-body">
            <div class="container-xl">
                <div class="card p-2 shadow-sm">
                    @include('company.pages.delivery-challan._form', ['formMode' => 'edit'])
                </div>
            </div>
        </div>
    </div>
@include('company.partials._shortcuts-bar', [
    'barModuleLabel'     => 'Delivery Challan Edit',
    'barModuleShortcuts' => [
...
@section('script')
    <script>
        ...
        const getChallanUrl = "{{ route('delivery-challans.show', ':id') }}";
        const storeDeliveryChallanRouteUrl = "{{ route('delivery-challans.store') }}";
        const updateDeliveryChallanRouteUrl = "{{ route('delivery-challans.update', ':id') }}";
        const deliveryChallanPrintLetterUrl = "{{ route('delivery-challans.print-letter', ':id') }}";    
</script>
    <script src="{{ asset('js/modules/delivery-challan/edit.js') }}?v={{ hash_file('md5', public_path('js/modules/delivery-challan/edit.js')) }}"></script>
