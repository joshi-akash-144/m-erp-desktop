                    ...
                    <div class="px-4 pb-3" style="padding-top:48px !important;">
                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                            <div>
                                ...
                                <div class="text-muted small mt-1">Update cheque print formats with their details.</div>
                            </div>
        ...
        <div class="page-body">
            <div class="container-xl">
                <div class="card p-2 shadow-sm">
                    @include('company.pages.setup.cheque._form',['formMode' => 'edit'])
                </div>
            </div>
        </div>
    </div>
...
@section('script')
    <script>
        const storeChequeFormat = "{{ route('cheque.update', $cheque->id) }}";
