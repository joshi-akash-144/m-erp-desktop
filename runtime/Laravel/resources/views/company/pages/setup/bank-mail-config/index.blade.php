...
@section('title', 'Bank Mail Configuration')
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div class="ms-md-3">
                            <span class="badge badge-pill bg-danger-lt text-white fw-bold text-uppercase shadow-sm px-3 py-1" style="font-size: 0.75rem; letter-spacing: 0.5px;">
                                <i class="fa-solid fa-envelope"></i> Bank Mail
                            </span>
                        </div>
                    </div>
                ...
                <div class="col-12 col-lg-10 col-xl-10">
                    <div class="card config-card shadow-sm">
                        <div class="card-header d-flex align-items-center gap-2 py-3">
                            ...
                            <span>SMTP Bank Mail Settings</span>
                        </div>
                        <div class="card-body">
                            <form id="form_bank_mail_config">
                                @csrf
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="password-wrapper">
                                            <input type="password" class="form-control pe-5" id="bank_mail_password" name="password"
                                                placeholder="{{ $config?->password ? '••••••••••••' : 'Enter SMTP password' }}">
                                            <button type="button" class="toggle-password" data-target="bank_mail_password">
                                                <i class="fa-regular fa-eye" id="eye_bank_mail_password"></i>
                                            </button>
                                        </div>
                                    </div>
                        ...
                        <div class="card-footer d-flex justify-content-end py-3">
                            <button type="button" class="btn btn-primary form-save-btn waves-effect" id="btn_save_bank_mail_config">
                                <i class="fa-solid fa-floppy-disk me-1"></i> Save Bank Mail Config
                            </button>
                        </div>
                    </div>
                </div>
...
@section('script')
<script>
    const updateUrl = "{{ route('bank-mail-config.update') }}";
    ...
    // Save
    document.getElementById('btn_save_bank_mail_config').addEventListener('click', function () {
        const btn  = this;
        const form = document.getElementById('form_bank_mail_config');

        Swal.fire({
            title: 'Save Bank Mail Configuration?',
            text: 'Are you sure you want to update the bank mail settings?',
            icon: 'question',
            ...
            .finally(function () {
                btn.disabled = false;
                btn.innerHTML = '<i class="fa-solid fa-floppy-disk me-1"></i> Save Bank Mail Config';
            });
        });
    });
</script>
