...
@section('title', 'Credit Note Voucher Create')
@section('css')
<link rel="stylesheet"
            ...
            <div class="card border-0 shadow-sm rounded-0" style="background: linear-gradient(145deg, #ffffff, #f8f9fa);">
                <div class="card-body p-1 d-flex flex-wrap align-items-center justify-content-between gap-3 border-start border-4 border-primary rounded-0">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        @can('credit_note_voucher.edit')
                        <a href="{{ route('credit-note-vouchers.edit') }}"
    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="card p-2 shadow-sm">
                @include('company.pages.credit-note-voucher._form', ['formMode' => 'create'])
            </div>
        </div>
    </div>
</div>
...
'barModuleLabel' => 'Credit Note Voucher Create',
'barModuleShortcuts' => [
...
@section('script')
<script
    src="{{ asset('js/modules/credit-note-voucher/create.js') }}?v={{ hash_file('md5', public_path('js/modules/credit-note-voucher/create.js')) }}">
</script>
@endsection