...
@section('title', 'Credit Note Voucher Edit')
@section('css')
    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="card p-2 shadow-sm">
                @include('company.pages.credit-note-voucher._form', ['formMode' => 'edit'])
            </div>
        </div>
    </div>
</div>
@include('company.pages.credit-note-voucher._ref_modal')
@include('company.pages.credit-note-voucher._pending_ref_modal')
@endsection
<script>
    ...
    const storeCreditNoteVoucher = "{{ route('credit-note-vouchers.store') }}";
    const indexCreditNoteVoucher = "{{ route('credit-note-vouchers.index') }}";
    const editCreditNoteVoucher = "{{ route('credit-note-vouchers.edit') }}";
    const updateCreditNoteVoucher = "{{ url('/vouchers/credit-note-vouchers') }}";
</script>

@section('script')
<script src="{{ asset('js/modules/credit-note-voucher/create.js') }}?v={{ hash_file('md5', public_path('js/modules/credit-note-voucher/create.js')) }}"></script>
<script src="{{ asset('js/modules/credit-note-voucher/edit.js') }}?v={{ hash_file('md5', public_path('js/modules/credit-note-voucher/edit.js')) }}"></script>
@endsection