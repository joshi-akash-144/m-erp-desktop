            ...
            <div class="px-4 pb-3" style="padding-top:48px !important;">
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                    <div>
                        ...
                        <div class="text-muted small mt-1">Edit email templates used across the system.</div>
                    </div>
            ...
            <div class="et-main-card">
                <form id="form_edit_template">
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-4">
                                ...
                                <input type="text" class="form-control form-control-sm" id="name" name="name"
                                    value="{{ $emailTemplate->name }}" placeholder="Template Name" autocomplete="off">
                            </div>
                            <div class="col-12 col-md-4">
                                ...
                                <input type="text" class="form-control form-control-sm bg-light" id="slug" name="slug"
                                    value="{{ $emailTemplate->slug }}" placeholder="template-slug" autocomplete="off">
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <input type="text" class="form-control form-control-sm" id="subject" name="subject"
                                    value="{{ $emailTemplate->subject }}" placeholder="Email Subject">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-1">
                        ...
                        <textarea id="message_editor" name="message">{!! $emailTemplate->message !!}</textarea>
                    </div>

                    {{-- Buttons --}}
                    <div class="d-flex justify-content-end gap-3 mt-4">
                        <a href="{{ route('back.to.previous') }}" onclick="window.location.reload();" class="btn btn-outline-secondary">
                            <i class="fa-solid fa-rotate-left me-1"></i> Clear
                        </a>
                        <button type="button" class="btn btn-primary form-save-btn waves-effect" id="btn_update">
...
<script>
    const updateUrl = "{{ route('email-templates.update', $emailTemplate->id) }}";
    ...
    document.getElementById('btn_update').addEventListener('click', function () {
        ...
        const data = new FormData(document.getElementById('form_edit_template'));
        ...
        .finally(() => { btn.disabled = false; btn.innerHTML = '<i class="fa-solid fa-floppy-disk me-1"></i> Update'; });
    });
</script>
@endsection
