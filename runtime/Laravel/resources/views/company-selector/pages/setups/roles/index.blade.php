            ...
            <div class="card border-0 shadow-sm rounded-4 mb-4">
                ...
                <div class="px-4 pb-3" style="padding-top:48px !important;">
                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                        <div>
                            <h3 class="mb-0 fw-bold">Roles</h3>
                            <div class="text-muted small mt-1">Manage system roles and their module permissions</div>
                        </div>
                    ...
                    <div class="card-body border-bottom px-4 py-3">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4 col-lg-3">
                                ...
                                <select id="role_id" class="form-select role-select">
...
<script>
    ...
    const roleViewUrl   = "{{ route('roles.show', ':id') }}";
    const roleEditUrl   = "{{ route('roles.edit', ':id') }}";
    const roleDeleteUrl = "{{ route('roles.destroy', ':id') }}";
</script>
<script src="{{ asset('js/role/index.js') }}?v={{ hash_file('md5', public_path('js/role/index.js')) }}"></script>
