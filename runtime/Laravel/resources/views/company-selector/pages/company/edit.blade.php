...
<div class="page-wrapper">
    <div class="page-body pt-4">
        <div class="container-xl">
            ...
            <div class="card border-0 shadow-sm rounded-4 mb-4">
                ...
                <div class="px-4 pb-3" style="padding-top:48px !important;">
                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                        <div>
                            <h3 class="mb-0 fw-bold">Update Company Details</h3>
                            <div class="text-muted small mt-1">Update the details of the company</div>
                        </div>
            ...
            {{-- ── FORM ── --}}
            <form method="POST" autocomplete="off" id="company_form">
                @csrf              
                @method('PUT')
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" id="name" value="{{ $company->name }}" disabled class="form-control"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="print_name" id="print_name" value="{{ $company->print_name }}" class="form-control"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="legal_name" id="legal_name" value="{{ $company->legal_name }}" disabled class="form-control"
                    ...
                    <div class="card-body p-4">
                        <div class="row g-4">
                            ...
                            <div class="col-md-2">
                                ...
                                <select name="country_id" id="country_id" class="form-select select2" disabled>
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="state_id" id="state_id" class="form-select select2" disabled>
                                    <option value="">-- Select --</option>
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="postal_code" id="postal_code" disabled value="{{ $company->postal_code }}" class="form-control"
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="address_one" id="address_one" value="{{ $company->address_one }}" disabled class="form-control"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="address_two" id="address_two" value="{{ $company->address_two }}" disabled class="form-control"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="mobile_number" id="mobile_number" value="{{ $company->mobile_number }}" class="form-control"
                    ...
                    <div class="card-body p-4">
                        <div class="row g-4">
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="type_of_dealer" id="type_of_dealer" disabled class="form-select select2">
                                    <option value="">-- Select --</option>
                                    @foreach ($typeOfDealer as $id => $dealer)
                                        <option value="{{ $id }}" {{ $company->type_of_dealer == $id ? 'selected' : '' }}>{{ $dealer }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="gst_number" id="gst_number" readonly value="{{ $company->gst_number }}" class="form-control readonly"
                                        placeholder="15-digit GSTIN" maxlength="15" disabled>
                                </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="cin" id="cin" disabled value="{{ $company->cin }}" class="form-control"
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="pan" id="pan" value="{{ $company->pan }}" class="form-control"
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="financial_year_start" id="financial_year_start"
                                        disabled class="form-control" value="{{ $company->financial_year_start ? format_date($company->financial_year_start) : '' }}" placeholder="DD-MM-YYYY">
                                </div>
                            </div>
...
<div class="col-md-3 d-flex align-items-center mt-4">
    <div class="form-check form-switch mt-2">
        <input class="form-check-input" type="checkbox" name="tds_applicable" id="tds_applicable" value="1" {{
            $company->tds_applicable ? 'checked' : '' }}>
            ...
            TDS Applicable
                    ...
                    <div class="card-footer bg-transparent border-top px-4 py-3">
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary d-inline-flex align-items-center gap-1 form-save-btn"
                                data-bs-toggle="tooltip" data-bs-placement="top" title="Update (Alt + S)">
...
@section('script')
<script>
    const UpdateCompanyUrl   = "{{ route('companies.update', $company->id) }}";    
</script>
<script src="{{ asset('js/company-edit.js') }}?v={{ hash_file('md5', public_path('js/company-edit.js')) }}"></script>
@endsection
