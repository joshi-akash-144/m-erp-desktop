            ...
            <div class="card border-0 shadow-sm rounded-4 mb-4">
                <div class="position-relative"
                    ...
                    <span class="d-inline-flex align-items-center justify-content-center rounded-3 border border-4 border-white shadow position-absolute text-white"
                        ...
                        <i class="fa-solid fa-building-user" style="font-size:26px;"></i>
                    </span>
                </div>
                <div class="px-4 pb-3" style="padding-top:48px !important;">
                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                        <div>
                            <h3 class="mb-0 fw-bold">Company Assign to User</h3>
                            <div class="text-muted small mt-1">Manage which users have access to each company</div>
                        </div>
                    ...
                    <div class="card-body border-bottom px-4 py-3">
                        <div class="row g-3">
                            <div class="col-md-4 col-lg-3">
                                ...
                                <div class="input-group input-group-flat">
                                    ...
                                    <input type="text" id="search" class="form-control"
                                        placeholder="Company, user, email…" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-md-4 col-lg-3">
                                <label class="form-label fw-semibold small">Company</label>
                                <select id="filter_company_id" class="form-select company-select">
                            ...
                            <div class="col-md-4 col-lg-3">
                                ...
                                <select id="filter_user_id" class="form-select user-select">
                            ...
                            <div class="col-md-4 col-lg-3">
                                ...
                                <select id="filter_status" class="form-select status-select">
...
@section('scripts')
<script>
    const getCompanyUsersUrl = "{{ route('company-users.index') }}";
    const deleteCompanyUserUrl = "{{ route('company-users.destroy') }}";
    const updateCompanyUserUrl = "{{ route('company-users.update') }}";
</script>
<script src="{{ asset('js/utils/icons.js') }}?v={{ hash_file('md5', public_path('js/utils/icons.js')) }}"></script>
<script src="{{ asset('js/company-users/index.js') }}?v={{ filemtime(public_path('js/company-users/index.js')) }}"></script>
@endsection
