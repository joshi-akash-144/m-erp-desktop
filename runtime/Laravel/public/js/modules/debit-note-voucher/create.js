...
class VoucherTableManager {
  ...
  initEvents() {
    ...
    // Form submit
    $("#debit_note_voucher_form").on("submit", (e) => this.handleStore(e));
  }
  ...
  async handleStore(e) {
    ...
    const url = isEdit ? `${updateDebitNoteVoucher}/${voucherId}` : storeDebitNoteVoucher;
    ...
    try {
      ...
      Swal.fire({
        icon: "success",
        title: "Success",
        html: `Debit Note Voucher <b class='text-primary'>${response.data.voucher_serial}</b> has been ${action} successfully.`,
