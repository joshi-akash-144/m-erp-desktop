...
const FILTER_KEY = "payment_voucher_register_filter";
const WIDTH_KEY = "payment_voucher_register_col_widths";
...
$(document).ready(function () {
    ...
    ajaxURL: (currentFilter.start_date && currentFilter.end_date) ? paymentVoucherRegisterListUrl : null,
...
function applyFilter() {
    ...
    if (table) table.setData(paymentVoucherRegisterListUrl);
}
