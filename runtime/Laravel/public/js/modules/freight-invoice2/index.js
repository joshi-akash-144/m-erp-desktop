...
const FILTER_KEY = "freight_invoice2_filter";
const WIDTH_KEY = "freight_invoice2_col_widths";
const PAGE_SIZE_KEY = "freight_invoice2_page_size";
const PAGE_NUM_KEY = "freight_invoice2_page_num";
...
function getColumns(saved) {
  return [
    ...
    },
    {
      title: "Date",
      field: "item_date",
      width: saved.item_date ?? 100,
      headerSort: false,
    },
    {
      title: "Code",
      field: "code",
      width: saved.code ?? 100,
      headerSort: false,
    },
    {
      title: "Society Name",
      field: "society_name",
      width: saved.society_name ?? 250,
      headerSort: false,
    },
    {
      title: "Route",
      field: "route",
      width: saved.route ?? 120,
      headerSort: false,
    },
    {
      title: "Bag",
      field: "bag_count",
      width: saved.bag_count ?? 80,
    ...
    },
    {
      title: "Vehicle No.",
      field: "vehicle_no",
      width: saved.vehicle_no ?? 120,
      headerSort: false,
    },
    {
      title: "Vendor",
      field: "vendor",
      width: saved.vendor ?? 100,
      headerSort: false,
    },
    {
      title: "KM",
    ...
    },
    {
      ...
      formatter: function(cell) {
         ...
         return formatIndianNumber(cell.getValue(), 2);
      },
    },
    {
      title: "Contractor",
      field: "contractor",
      width: saved.contractor ?? 150,
      headerSort: false,
    },
    {
      title: "Actions",
      ...
      formatter: (cell) => {
        ...
        if (canEdit) {
          actions += `
            <span class="erp-btn-icon edit" data-id="${row.id}" style="stroke-width:1px !important" title="Edit Freight Invoice">
                ${editIcon}
            </span>`;
        }
        ...
        if (canPrint) {
          actions += `
            <span class="erp-btn-icon print" data-id="${row.id}" style="stroke-width:1px !important" title="Print Freight Invoice">
                ${printIcon}
            </span>`;
        }
...
$(document).ready(function () {
  ...
  table = new Tabulator("#freight_invoice_2_table", {
    height: "550px",
    layout: "fitColumns",
    ...
    ajaxURL: freightInvoice2ListUrl,
