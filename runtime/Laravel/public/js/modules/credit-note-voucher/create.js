...
class VoucherTableManager {
  ...
  initEvents() {
    ...
    // Form submit
    $("#credit_note_voucher_form").on("submit", (e) => this.handleStore(e));
  }
  ...
  async handleStore(e) {
    ...
    const url = isEdit ? `${updateCreditNoteVoucher}/${voucherId}` : storeCreditNoteVoucher;
    ...
    try {
      ...
      Swal.fire({
        icon: "success",
        title: "Success",
        html: `Credit Note Voucher <b class='text-primary'>${response.data.voucher_serial}</b> has been ${action} successfully.`,
