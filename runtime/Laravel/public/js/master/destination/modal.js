(function () {
    ...
    $(document).ready(function () {
        // validation
        validator = new JustValidate("#destination_form", {
        ...
        validator
            .addField("#name", [
                { rule: "required", errorMessage: "Destination Name is required" },
            ...
            .onSuccess((event) => {
                ...
                submitFormAjax(document.getElementById("destination_form"));
            });
    ...
    function submitFormAjax(form) {
        ...
        const $form = $(form);
        const $btn = $("#destination_modal .form-save-btn");
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (success) {
                    showToast("success", message || (isEdit ? "Destination updated successfully!" : "Destination saved successfully!"));
