(function () {
    ...
    $(document).ready(function () {
        // validation
        validator = new JustValidate("#vehicle_owner_form", {
            ...
            .onSuccess((event) => {
                ...
                submitFormAjax(document.getElementById("vehicle_owner_form"));
            });
    });
    ...
    function submitFormAjax(form) {
        ...
        const $form = $(form);
        const $btn = $("#vehicle_owner_modal .form-save-btn");
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (success) {
                    showToast("success", message || (isEdit ? "Vehicle Owner updated successfully!" : "Vehicle Owner saved successfully!"));
                     $('#vehicle_owner_modal').modal('hide');
            ...
            complete: function () {
                if ($btn.length) {
                    $btn.prop("disabled", false).html(`
                        ...
                        ${isEdit ? "Update Vehicle Owner" : "Save Vehicle Owner"}
                    `);
                }
                isSubmitting = false;               
            }
