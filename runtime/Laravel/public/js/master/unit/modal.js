(function () {
    ...
    $(document).ready(function () {
        const formEl = document.getElementById("unit_form");
        ...
        // validation
        validator = new JustValidate("#unit_form", {
        ...
        validator
            .addField("#name", [
                { rule: "required", errorMessage: "Unit Name is required" },
            ...
            .onSuccess((event) => {
                ...
                submitFormAjax(document.getElementById("unit_form"));
            });
        // Custom Enter Key Navigation
        $("#uqc").on("keydown", function (e) {
            if (e.which === 13) {
                e.preventDefault();
                $(".form-save-btn").focus();
            }
    ...
    function submitFormAjax(form) {
        ...
        const $form = $(form);
        const $btn = $("#unit_modal .form-save-btn");
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (success) {
                    showToast("success", message || (isEdit ? "Unit updated successfully!" : "Unit saved successfully!"));
