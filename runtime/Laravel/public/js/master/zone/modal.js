(function () {
    ...
    $(document).ready(function () {
        const formEl = document.getElementById("zone_form");
        ...
        // validation
        validator = new JustValidate("#zone_form", {
        ...
        validator
            .addField("#name", [
                { rule: "required", errorMessage: "Zone name is required" }
            ])
            .addField("#rate", [
                { rule: "required", errorMessage: "Rate is a required field" },
                { rule: "number", errorMessage: "Rate must be a number" },
            ])
            .onSuccess((event) => {
                event.preventDefault();
                submitFormAjax(document.getElementById("zone_form"));
            });
    ...
    function submitFormAjax(form) {
        ...
        const $form = $(form);
        const $btn = $("#zone_modal .form-save-btn");
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (success) {
                    showToast("success", message || (isEdit ? "Zone updated successfully!" : "Zone saved successfully!"));
                    if (typeof refreshTable === "function") {
                        refreshTable("zone_table");
