(function () {
    ...
    $(document).ready(function () {
        const formEl = document.getElementById("sale_type_form");
        ...
        // validation
        validator = new JustValidate("#sale_type_form", {
        ...
        validator
            .addField("#name", [
                { rule: "required", errorMessage: "Sale Type Name is required" },
            ...
            .onSuccess((event) => {
                ...
                submitFormAjax(document.getElementById("sale_type_form"));
            });        
...
function toggleGSTSection() {
    ...
    function submitFormAjax(form) {
        ...
        const $form = $(form);
        const $btn = $("#sale_type_modal .form-save-btn");
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (success) {
                    showToast("success", message || (isEdit ? "Sale Type updated successfully!" : "Sale Type saved successfully!"));
            ...
            complete: function () {
                if ($btn.length) {
                    $btn.prop("disabled", false).html(`
                        ...
                        ${isEdit ? "Update Sale Type" : "Save Sale Type"}
                    `);
                }
                isSubmitting = false;
                $('#sale_type_modal').modal('hide');
            }
        });
    }
})();